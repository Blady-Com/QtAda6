...
package QtAda6.QtGui.QOpenGLContext is
   ...
   function aboutToBeDestroyed (self : access Inst) return CLASSVAR_Signal;-- aboutToBeDestroyed()
   ...
   function getProcAddress (self : access Inst; procName_P : UNION_QtAda6_QtCore_QByteArraybytes) return int;
   function globalShareContext return access QtAda6.QtGui.QOpenGLContext.Inst'Class;
   function hasExtension (self : access Inst; extension_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool;
