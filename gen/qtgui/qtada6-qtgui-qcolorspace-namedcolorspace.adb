...
package body QtAda6.QtGui.QColorSpace.NamedColorSpace is
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColorSpace");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "SRgbLinear"));
   end SRgbLinear;
   function AdobeRgb return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColorSpace");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AdobeRgb"));
   end AdobeRgb;
   function DisplayP3 return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColorSpace");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DisplayP3"));
   end DisplayP3;
