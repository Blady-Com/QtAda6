...
package body QtAda6.QtGui.QPageLayout.Mode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "StandardMode"));
   end StandardMode;
   function FullPageMode return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPageLayout");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "FullPageMode"));
   end FullPageMode;
