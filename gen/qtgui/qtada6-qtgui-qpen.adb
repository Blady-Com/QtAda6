...
package body QtAda6.QtGui.QPen is
   ...
   function Create (color_P : access QtAda6.QtGui.QColor.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPen");
      Args  := Tuple_New (1);
   ...
   function Create (color_P : access QtAda6.QtGui.QRgba64.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPen");
      Args  := Tuple_New (1);
   ...
   function Create (color_P : Any) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPen");
      Args  := Tuple_New (1);
   ...
   function Create (color_P : str) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPen");
      Args  := Tuple_New (1);
   ...
   function Create (color_P : int) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPen");
      Args  := Tuple_New (1);
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtGui.QPen.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtCore.Qt.PenStyle.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "swap");
      Args   := Tuple_New (1);
