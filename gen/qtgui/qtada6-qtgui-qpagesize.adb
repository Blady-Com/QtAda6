...
package body QtAda6.QtGui.QPageSize is
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPageSize");
      Args  := Tuple_New (1);
      Tuple_SetItem (Args, 0, pageSizeId_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPageSize");
      Args  := Tuple_New (3);
      Tuple_SetItem (Args, 0, pointSize_P.Python_Proxy);
      Tuple_SetItem (Args, 1, Unicode_FromString (name_P));
      Tuple_SetItem (Args, 2, matchPolicy_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create
   ...
   begin
      ...
      Tuple_SetItem (Args, 3, matchPolicy_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, pointSize_P.Python_Proxy);
      Tuple_SetItem (Args, 1, matchPolicy_P.Python_Proxy);
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end id_F;
