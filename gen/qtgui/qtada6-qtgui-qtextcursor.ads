...
package QtAda6.QtGui.QTextCursor is
   ...
   procedure insertImage (self : access Inst; image_P : access QtAda6.QtGui.QImage.Inst'Class; name_P : str := "");
   procedure insertImage (self : access Inst; image_P : str; name_P : str := "");
