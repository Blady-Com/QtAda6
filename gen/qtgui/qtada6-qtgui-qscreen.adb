...
package body QtAda6.QtGui.QScreen is
   ...
   function availableGeometryChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function logicalDotsPerInchChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "logicalDotsPerInchChanged"));
   end logicalDotsPerInchChanged;
   function orientationChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "orientationChanged"));
   end orientationChanged;
   function physicalDotsPerInchChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "physicalDotsPerInchChanged"));
   end physicalDotsPerInchChanged;
   function physicalSizeChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function primaryOrientationChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "primaryOrientationChanged"));
   end primaryOrientationChanged;
   function refreshRateChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function virtualGeometryChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
   ...
   begin
      ...
      Dict := Dict_New;
      if x_P /= 0 then
         Dict_SetItemString (Dict, "x", Long_FromLong (x_P));
      end if;
      if y_P /= 0 then
         Dict_SetItemString (Dict, "y", Long_FromLong (y_P));
      end if;
      if w_P /= 0 then
         Dict_SetItemString (Dict, "w", Long_FromLong (w_P));
      end if;
      if h_P /= 0 then
         Dict_SetItemString (Dict, "h", Long_FromLong (h_P));
      end if;
      Result           := Object_Call (Method, Args, Dict, True);
      Ret.Python_Proxy := Result;
      return Ret;
