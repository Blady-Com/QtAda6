...
function Create(font_P : Union_QtAda6_QtGui_QFont_str_Sequence_str;pd_P : access QtAda6.QtGui.QPaintDevice.Inst'Class) return Class;
procedure U_copy_U;
function ascent(self : access Inst) return float;
function averageCharWidth(self : access Inst) return float;
function boundingRect(self : access Inst;r_P : Union_QtAda6_QtCore_QRectF_QtAda6_QtCore_QRect;flags_P : int;string_P : str;tabstops_P : int;tabarray_P : object) return access QtAda6.QtCore.QRectF.Inst'Class;
function boundingRect(self : access Inst;string_P : str) return access QtAda6.QtCore.QRectF.Inst'Class;
function boundingRect(self : access Inst;text_P : str;textOption_P : Union_QtAda6_QtGui_QTextOption_QtAda6_QtCore_Qt_AlignmentFlag) return access QtAda6.QtCore.QRectF.Inst'Class;
...
function elidedText(self : access Inst;text_P : str;mode_P : access QtAda6.QtCore.Qt.TextElideMode.Inst'Class;width_P : float;flags_P : int) return str;
...
function horizontalAdvance(self : access Inst;string_P : str;textOption_P : Union_QtAda6_QtGui_QTextOption_QtAda6_QtCore_Qt_AlignmentFlag) return float;
...
function size(self : access Inst;flags_P : int;str_P : str;tabstops_P : int;tabarray_P : object) return access QtAda6.QtCore.QSizeF.Inst'Class;
...
function tightBoundingRect(self : access Inst;text_P : str;textOption_P : Union_QtAda6_QtGui_QTextOption_QtAda6_QtCore_Qt_AlignmentFlag) return access QtAda6.QtCore.QRectF.Inst'Class;
