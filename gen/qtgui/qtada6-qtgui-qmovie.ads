...
package QtAda6.QtGui.QMovie is
   ...
   function Create
     (device_P : access QtAda6.QtCore.QIODevice.Inst'Class;
      format_P : access QtAda6.QtCore.QByteArray.Inst'Class := null;
      parent_P : access QtAda6.QtCore.QObject.Inst'Class    := null) return Class;
   function Create
     (device_P : access QtAda6.QtCore.QIODevice.Inst'Class; format_P : bytes := null;
      parent_P : access QtAda6.QtCore.QObject.Inst'Class := null) return Class;
   function Create
     (fileName_P : str; format_P : access QtAda6.QtCore.QByteArray.Inst'Class := null;
      parent_P   : access QtAda6.QtCore.QObject.Inst'Class := null) return Class;
   function Create
     (fileName_P : str; format_P : bytes := null; parent_P : access QtAda6.QtCore.QObject.Inst'Class := null)
      return Class;
   ...
   procedure setBackgroundColor (self : access Inst; color_P : access QtAda6.QtGui.QColor.Inst'Class);
   procedure setBackgroundColor (self : access Inst; color_P : access QtAda6.QtGui.QRgba64.Inst'Class);
   procedure setBackgroundColor (self : access Inst; color_P : Any);
   procedure setBackgroundColor (self : access Inst; color_P : access QtAda6.QtCore.Qt.GlobalColor.Inst'Class);
   procedure setBackgroundColor (self : access Inst; color_P : str);
   procedure setBackgroundColor (self : access Inst; color_P : int);
