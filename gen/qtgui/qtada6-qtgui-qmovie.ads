...
function Create(device_P : access QtAda6.QtCore.QIODevice.Inst'Class;format_P : Union_QtAda6_QtCore_QByteArray_bytes;parent_P : Optional_QtAda6_QtCore_QObject) return Class;
function Create(fileName_P : str;format_P : Union_QtAda6_QtCore_QByteArray_bytes;parent_P : Optional_QtAda6_QtCore_QObject) return Class;
...
procedure setBackgroundColor(self : access Inst;color_P : Union_QtAda6_QtGui_QColor_QtAda6_QtGui_QRgba64_Any_QtAda6_QtCore_Qt_GlobalColor_str_int);
