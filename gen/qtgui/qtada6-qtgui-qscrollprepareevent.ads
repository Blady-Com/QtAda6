...
package QtAda6.QtGui.QScrollPrepareEvent is
   ...
   procedure setContentPosRange (self : access Inst; rect_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect);
   procedure setViewportSize (self : access Inst; size_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize);
