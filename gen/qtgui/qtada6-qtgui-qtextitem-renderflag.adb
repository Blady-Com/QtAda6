-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtgui-qtextitem-renderflag.adb
...
package body QtAda6.QtGui.QTextItem.RenderFlag is
   use type QtAda6.int;
   ...
   function RightToLeft return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QTextItem");
   ...
   function Dummy return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QTextItem");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Dummy"));
   end Dummy;
