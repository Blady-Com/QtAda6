...
package body QtAda6.QtGui.QImage is
   ...
   function Create (arg_1_P : UNION_QtAda6_QtGui_QImagestr) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QImage");
      Args  := Tuple_New (1);
   ...
   begin
      ...
      Tuple_SetItem (Args, 5, (if cleanupFunction_P /= null then cleanupFunction_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 6, Long_FromLong (cleanupInfo_P));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create
   ...
   begin
      ...
      Tuple_SetItem (Args, 4, (if cleanupFunction_P /= null then cleanupFunction_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 5, Long_FromLong (cleanupInfo_P));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create (fileName_P : UNION_strbytesos_PathLike; format_P : bytes := "") return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QImage");
      Args  := Tuple_New (2);
   ...
   function fromData
     (data_P : UNION_QtAda6_QtCore_QByteArraybytes; format_P : bytes := "") return access QtAda6.QtGui.QImage.Inst'Class
   is
      Class, Method, Args, List, Result : Handle;
      Ret                               : constant QtAda6.QtGui.QImage.Class := new QtAda6.QtGui.QImage.Inst;
   begin
   ...
   procedure setAlphaChannel (self : access Inst; alphaChannel_P : UNION_QtAda6_QtGui_QImagestr) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtGui_QImagestr) is
      Method, Args, List, Result : Handle;
   begin
