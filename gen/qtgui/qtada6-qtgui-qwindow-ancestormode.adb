...
package body QtAda6.QtGui.QWindow.AncestorMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ExcludeTransients"));
   end ExcludeTransients;
   function IncludeTransients return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IncludeTransients"));
