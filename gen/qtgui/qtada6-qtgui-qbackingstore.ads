...
procedure beginPaint(self : access Inst;arg_1_P : Union_QtAda6_QtGui_QRegion_QtAda6_QtGui_QBitmap_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRect);
procedure endPaint(self : access Inst);
procedure flush(self : access Inst;region_P : Union_QtAda6_QtGui_QRegion_QtAda6_QtGui_QBitmap_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRect;window_P : Optional_QtAda6_QtGui_QWindow;offset_P : access QtAda6.QtCore.QPoint.Inst'Class);
...
function scroll(self : access Inst;area_P : Union_QtAda6_QtGui_QRegion_QtAda6_QtGui_QBitmap_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRect;dx_P : int;dy_P : int) return bool;
procedure setStaticContents(self : access Inst;region_P : Union_QtAda6_QtGui_QRegion_QtAda6_QtGui_QBitmap_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRect);
