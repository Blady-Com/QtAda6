...
function Create(type_K_P : access QtAda6.QtCore.QEvent.Type_K.Inst'Class;pos_P : access QtAda6.QtCore.QPoint.Inst'Class;globalPos_P : access QtAda6.QtCore.QPoint.Inst'Class) return Class;
