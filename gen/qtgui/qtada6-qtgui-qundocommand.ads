...
package QtAda6.QtGui.QUndoCommand is
   ...
   function Create (parent_P : access QtAda6.QtGui.QUndoCommand.Inst'Class := null) return Class;
   function Create (text_P : str; parent_P : access QtAda6.QtGui.QUndoCommand.Inst'Class := null) return Class;
