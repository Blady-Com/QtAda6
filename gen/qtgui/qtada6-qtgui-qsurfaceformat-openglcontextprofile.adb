...
package body QtAda6.QtGui.QSurfaceFormat.OpenGLContextProfile is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NoProfile"));
   end NoProfile;
   function CoreProfile return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QSurfaceFormat");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CoreProfile"));
   end CoreProfile;
   function CompatibilityProfile return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QSurfaceFormat");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CompatibilityProfile"));
