...
function Create(iface_P : access QtAda6.QtGui.QAccessibleInterface.Inst'Class;changeType_P : access QtAda6.QtGui.QAccessibleTableModelChangeEvent.ModelChangeType.Inst'Class) return Class;
function Create(obj_P : access QtAda6.QtCore.QObject.Inst'Class;changeType_P : access QtAda6.QtGui.QAccessibleTableModelChangeEvent.ModelChangeType.Inst'Class) return Class;
...
function modelChangeType_F(self : access Inst) return access QtAda6.QtGui.QAccessibleTableModelChangeEvent.ModelChangeType.Inst'Class;
...
procedure setModelChangeType(self : access Inst;changeType_P : access QtAda6.QtGui.QAccessibleTableModelChangeEvent.ModelChangeType.Inst'Class);
