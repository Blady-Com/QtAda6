...
package QtAda6.QtGui.QStandardItem is
   ...
   function Create (rows_P : int; columns_P : int) return Class;
   ...
   function child (self : access Inst; row_P : int; column_P : int) return access QtAda6.QtGui.QStandardItem.Inst'Class;
   ...
   procedure setData (self : access Inst; value_P : Any; role_P : int);
