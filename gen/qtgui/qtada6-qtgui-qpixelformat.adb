...
package body QtAda6.QtGui.QPixelFormat is
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPixelFormat");
      Args  := Tuple_New (1);
      Tuple_SetItem (Args, 0, QPixelFormat_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPixelFormat");
      Args  := Tuple_New (13);
      Tuple_SetItem (Args, 0, colorModel_P.Python_Proxy);
      ...
      Tuple_SetItem (Args, 7, alphaUsage_P.Python_Proxy);
      Tuple_SetItem (Args, 8, alphaPosition_P.Python_Proxy);
      Tuple_SetItem (Args, 9, premultiplied_P.Python_Proxy);
      Tuple_SetItem (Args, 10, typeInterpretation_P.Python_Proxy);
      Tuple_SetItem (Args, 11, byteOrder_P.Python_Proxy);
