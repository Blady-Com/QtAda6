...
package body QtAda6.QtGui.QTextCursor.MoveMode is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "MoveMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "MoveAnchor"));
   end MoveAnchor;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QTextCursor");
      Enum_Class   := Object_GetAttrString (Parent_Class, "MoveMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "KeepAnchor"));
   end KeepAnchor;
