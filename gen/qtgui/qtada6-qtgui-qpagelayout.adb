...
package body QtAda6.QtGui.QPageLayout is
   ...
   function Create
     (pageSize_P    : access QtAda6.QtGui.QPageSize.Inst'Class;
      orientation_P : access QtAda6.QtGui.QPageLayout.Orientation.Inst'Class;
      margins_P     : access QtAda6.QtCore.QMarginsF.Inst'Class;
      units_P       : access QtAda6.QtGui.QPageLayout.Unit.Inst'Class := null;
      minMargins_P  : access QtAda6.QtCore.QMarginsF.Inst'Class       := null) return Class
   is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPageLayout");
   ...
   function Create
     (pageSize_P    : access QtAda6.QtGui.QPageSize.Inst'Class;
      ...
      margins_P     : access QtAda6.QtCore.QMarginsF.Inst'Class;
      units_P       : access QtAda6.QtGui.QPageLayout.Unit.Inst'Class := null;
      minMargins_P  : access QtAda6.QtCore.QMargins.Inst'Class        := null) return Class
   is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPageLayout");
   ...
   function Create
     (pageSize_P    : access QtAda6.QtGui.QPageSize.Inst'Class;
      orientation_P : access QtAda6.QtGui.QPageLayout.Orientation.Inst'Class;
      margins_P     : access QtAda6.QtCore.QMargins.Inst'Class;
      units_P       : access QtAda6.QtGui.QPageLayout.Unit.Inst'Class := null;
      minMargins_P  : access QtAda6.QtCore.QMarginsF.Inst'Class       := null) return Class
   is
      Class, Args, Dict, List, Tuple, Set : Handle;
   ...
   function Create
     (pageSize_P    : access QtAda6.QtGui.QPageSize.PageSizeId.Inst'Class;
      orientation_P : access QtAda6.QtGui.QPageLayout.Orientation.Inst'Class;
      margins_P     : access QtAda6.QtCore.QMarginsF.Inst'Class;
      units_P       : access QtAda6.QtGui.QPageLayout.Unit.Inst'Class := null;
      minMargins_P  : access QtAda6.QtCore.QMarginsF.Inst'Class       := null) return Class
   ...
   function Create
     (pageSize_P    : access QtAda6.QtCore.QSize.Inst'Class;
      orientation_P : access QtAda6.QtGui.QPageLayout.Orientation.Inst'Class;
      margins_P     : access QtAda6.QtCore.QMarginsF.Inst'Class;
      units_P       : access QtAda6.QtGui.QPageLayout.Unit.Inst'Class := null;
      minMargins_P  : access QtAda6.QtCore.QMarginsF.Inst'Class       := null) return Class
   ...
   function setMargins (self : access Inst; margins_P : access QtAda6.QtCore.QMarginsF.Inst'Class) return bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   function setMargins (self : access Inst; margins_P : access QtAda6.QtCore.QMargins.Inst'Class) return bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMargins");
      Args   := Tuple_New (1);
   ...
   procedure setMinimumMargins (self : access Inst; minMargins_P : access QtAda6.QtCore.QMarginsF.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setMinimumMargins (self : access Inst; minMargins_P : access QtAda6.QtCore.QMargins.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMinimumMargins");
      Args   := Tuple_New (1);
   ...
   procedure setPageSize
     (self         : access Inst; pageSize_P : access QtAda6.QtGui.QPageSize.Inst'Class;
      minMargins_P : access QtAda6.QtCore.QMarginsF.Inst'Class := null)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setPageSize
     (self         : access Inst; pageSize_P : access QtAda6.QtGui.QPageSize.Inst'Class;
      minMargins_P : access QtAda6.QtCore.QMargins.Inst'Class := null)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setPageSize");
   ...
   procedure setPageSize
     (self         : access Inst; pageSize_P : access QtAda6.QtGui.QPageSize.PageSizeId.Inst'Class;
      minMargins_P : access QtAda6.QtCore.QMarginsF.Inst'Class := null)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setPageSize
     (self         : access Inst; pageSize_P : access QtAda6.QtCore.QSize.Inst'Class;
      minMargins_P : access QtAda6.QtCore.QMarginsF.Inst'Class := null)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
