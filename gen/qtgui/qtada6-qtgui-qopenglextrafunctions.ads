...
package QtAda6.QtGui.QOpenGLExtraFunctions is
   ...
   function glGetBooleani_v (self : access Inst; target_P : int; index_P : int) return bool;
   ...
   function glGetIntegeri_v (self : access Inst; arg_1_P : int; arg_2_P : int) return int;
