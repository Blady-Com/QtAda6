...
package QtAda6.QtGui.QPolygonF is
   ...
   function Create (QPolygonF_P : access QtAda6.QtGui.QPolygonF.Inst'Class) return Class;
   function Create (QPolygonF_P : SEQUENCE_QtAda6_QtCore_QRectF) return Class;
   function Create (a_P : access QtAda6.QtGui.QPolygon.Inst'Class) return Class;
   function Create (a_P : SEQUENCE_QtAda6_QtCore_QRect) return Class;
   function Create (r_P : access QtAda6.QtCore.QRectF.Inst'Class) return Class;
   function Create (r_P : access QtAda6.QtCore.QRect.Inst'Class) return Class;
   ...
   function U_rshift_U
     (self : access Inst; stream_P : access QtAda6.QtCore.QDataStream.Inst'Class)
      return access QtAda6.QtCore.QDataStream.Inst'Class;
   procedure append (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure append (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure append (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   ...
   procedure insert (self : access Inst; arg_1_P : int; arg_2_P : access QtAda6.QtCore.QPointF.Inst'Class);
   ...
   function intersects (self : access Inst; r_P : access QtAda6.QtGui.QPolygonF.Inst'Class) return bool;
   function intersects (self : access Inst; r_P : SEQUENCE_QtAda6_QtCore_QRectF) return bool;
   ...
   procedure prepend (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure prepend (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure prepend (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure push_back (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure push_back (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure push_back (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure push_front (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure push_front (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure push_front (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure remove (self : access Inst; i_P : int; n_P : int := 0);
   procedure removeAll (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure removeAll (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure removeAll (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure removeAt (self : access Inst; i_P : int);
   procedure removeFirst (self : access Inst);
   procedure removeLast (self : access Inst);
   procedure removeOne (self : access Inst; arg_1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure removeOne (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure removeOne (self : access Inst; arg_1_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   ...
   function subtracted
     (self : access Inst; r_P : SEQUENCE_QtAda6_QtCore_QRectF) return access QtAda6.QtGui.QPolygonF.Inst'Class;
   procedure swap (self : access Inst; other_P : access QtAda6.QtGui.QPolygonF.Inst'Class);
   procedure swap (self : access Inst; other_P : SEQUENCE_QtAda6_QtCore_QRectF);
