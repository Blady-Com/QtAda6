...
package QtAda6.QtGui.QPolygonF is
   ...
   function Create
     (QPolygonF_P : Union_QtAda6_QtGui_QPolygonF_Sequence_QtAda6_QtCore_QPointF_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRectF)
      return Class;
   function Create (a_P : Union_QtAda6_QtGui_QPolygon_Sequence_QtAda6_QtCore_QPoint_QtAda6_QtCore_QRect) return Class;
   ...
   function mid (self : access Inst; pos_P : int; len_P : int) return List_QtAda6_QtCore_QPointF;
