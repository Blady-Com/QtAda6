...
package QtAda6.QtGui.QIcon is
   ...
   function Create (other_P : access QtAda6.QtGui.QIcon.Inst'Class) return Class;
   function Create (other_P : access QtAda6.QtGui.QPixmap.Inst'Class) return Class;
...
-- function Create(pixmap_P : str) return Class;
   ...
   procedure addPixmap (self : access Inst; path_P : str);
   procedure addPixmap (self : access Inst; path_P : bytes);
   procedure addPixmap (self : access Inst; path_P : OS.PathLike);
   procedure addPixmap
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtGui.QIcon.Inst'Class);
