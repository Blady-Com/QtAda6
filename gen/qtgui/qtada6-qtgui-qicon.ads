...
package QtAda6.QtGui.QIcon is
   ...
   function Create (other_P : UNION_QtAda6_QtGui_QIconQtAda6_QtGui_QPixmap) return Class;
   ...
   procedure addPixmap (self : access Inst; path_P : UNION_strbytesos_PathLike);
   procedure addPixmap
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtGui_QIconQtAda6_QtGui_QPixmap);
