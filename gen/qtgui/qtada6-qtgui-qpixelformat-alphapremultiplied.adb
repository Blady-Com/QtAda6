...
package body QtAda6.QtGui.QPixelFormat.AlphaPremultiplied is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "AlphaPremultiplied");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NotPremultiplied"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPixelFormat");
      Enum_Class   := Object_GetAttrString (Parent_Class, "AlphaPremultiplied");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Premultiplied"));
   end Premultiplied;
