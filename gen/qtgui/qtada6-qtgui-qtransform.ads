...
package QtAda6.QtGui.QTransform is
   ...
   function quadToQuad
     (one_P    : SEQUENCE_QtAda6_QtCore_QRectF; two_P : SEQUENCE_QtAda6_QtCore_QRectF;
      result_P : access QtAda6.QtGui.QTransform.Inst'Class) return bool;
   function quadToSquare (arg_1_P : access QtAda6.QtGui.QPolygonF.Inst'Class) return access Object'Class;
   function quadToSquare (arg_1_P : SEQUENCE_QtAda6_QtCore_QRectF) return access Object'Class;
   ...
   function squareToQuad (arg_1_P : access QtAda6.QtGui.QPolygonF.Inst'Class) return access Object'Class;
   function squareToQuad (arg_1_P : SEQUENCE_QtAda6_QtCore_QRectF) return access Object'Class;
