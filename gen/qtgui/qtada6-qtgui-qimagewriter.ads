...
function Create(device_P : access QtAda6.QtCore.QIODevice.Inst'Class;format_P : Union_QtAda6_QtCore_QByteArray_bytes) return Class;
...
function imageFormatsForMimeType(mimeType_P : Union_QtAda6_QtCore_QByteArray_bytes) return List_QtAda6_QtCore_QByteArray;
...
procedure setTransformation(self : access Inst;orientation_P : access QtAda6.QtGui.QImageIOHandler.Transformation.Inst'Class);
...
function supportsOption(self : access Inst;option_P : access QtAda6.QtGui.QImageIOHandler.ImageOption.Inst'Class) return bool;
