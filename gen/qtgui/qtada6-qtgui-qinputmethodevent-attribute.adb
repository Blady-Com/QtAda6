...
function Create(typ_P : access QtAda6.QtGui.QInputMethodEvent.AttributeType.Inst'Class;s_P : int;l_P : int) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "Attribute");
  Args   := Tuple_New ( 3);
...
function Create(typ_P : access QtAda6.QtGui.QInputMethodEvent.AttributeType.Inst'Class;s_P : int;l_P : int;val_P : Any) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "Attribute");
  Args   := Tuple_New ( 4);
