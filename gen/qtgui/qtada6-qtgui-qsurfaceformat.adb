...
package body QtAda6.QtGui.QSurfaceFormat is
   ...
   function Create (other_P : UNION_QtAda6_QtGui_QSurfaceFormatQtAda6_QtGui_QSurfaceFormat_FormatOption) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QSurfaceFormat");
      Args  := Tuple_New (1);
   ...
   procedure setDefaultFormat (format_P : UNION_QtAda6_QtGui_QSurfaceFormatQtAda6_QtGui_QSurfaceFormat_FormatOption) is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QSurfaceFormat");
   ...
   function version (self : access Inst) return TUPLE_intint is
      Method, Args, List, Result : Handle;
   begin
