...
package QtAda6.QtGui.QPixmap is
   ...
   type Union_QtAda6_QtGui_QRegion_QtAda6_QtGui_QBitmap_QtAda6_QtGui_QPolygon_QtAda6_QtCore_QRect_NoneType is
     access Any;
   ...
   function save (self : access Inst; fileName_P : str; format_P : Optional_str; quality_P : int) return bool;
   function scaled
   ...
   procedure swap (self : access Inst; other_P : Union_QtAda6_QtGui_QPixmap_QtAda6_QtGui_QImage_str);
