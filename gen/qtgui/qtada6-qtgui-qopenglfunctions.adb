...
package body QtAda6.QtGui.QOpenGLFunctions is
   ...
   function glGetBooleanv (self : access Inst; pname_P : int) return UNION_boolLIST_Any is
      Method, Args, List, Result : Handle;
   begin
   ...
   function glGetFloatv (self : access Inst; arg_1_P : int) return UNION_floatLIST_Any is
      Method, Args, List, Result : Handle;
   begin
   ...
   function glGetIntegerv (self : access Inst; arg_1_P : int) return UNION_intLIST_Any is
      Method, Args, List, Result : Handle;
   begin
