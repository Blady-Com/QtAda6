...
procedure glBlendFuncSeparate(self : access Inst;srcRGB_P : int;dstRGB_P : int;srcAlpha_P : int;dstAlpha_P : int);
...
procedure glCompressedTexImage2D(self : access Inst;target_P : int;level_P : int;internalformat_P : int;width_P : int;height_P : int;border_P : int;imageSize_P : int;data_P : int);
procedure glCompressedTexSubImage2D(self : access Inst;target_P : int;level_P : int;xoffset_P : int;yoffset_P : int;width_P : int;height_P : int;format_P : int;imageSize_P : int;data_P : int);
procedure glCopyTexImage2D(self : access Inst;target_P : int;level_P : int;internalformat_P : int;x_P : int;y_P : int;width_P : int;height_P : int;border_P : int);
procedure glCopyTexSubImage2D(self : access Inst;target_P : int;level_P : int;xoffset_P : int;yoffset_P : int;x_P : int;y_P : int;width_P : int;height_P : int);
...
procedure glFramebufferRenderbuffer(self : access Inst;target_P : int;attachment_P : int;renderbuffertarget_P : int;renderbuffer_P : int);
procedure glFramebufferTexture2D(self : access Inst;target_P : int;attachment_P : int;textarget_P : int;texture_P : int;level_P : int);
...
procedure glGetAttachedShaders(self : access Inst;program_P : int;maxcount_P : int;count_P : Sequence_int;shaders_P : Sequence_int);
...
procedure glGetFramebufferAttachmentParameteriv(self : access Inst;target_P : int;attachment_P : int;pname_P : int;params_P : Sequence_int);
...
procedure glGetShaderPrecisionFormat(self : access Inst;shadertype_P : int;precisiontype_P : int;range_K_P : Sequence_int;precision_P : Sequence_int);
...
procedure glReadPixels(self : access Inst;x_P : int;y_P : int;width_P : int;height_P : int;format_P : int;type_K_P : int;pixels_P : int);
procedure glReleaseShaderCompiler(self : access Inst);
procedure glRenderbufferStorage(self : access Inst;target_P : int;internalformat_P : int;width_P : int;height_P : int);
...
procedure glShaderBinary(self : access Inst;n_P : int;shaders_P : Sequence_int;binaryformat_P : int;binary_P : int;length_P : int);
...
procedure glTexImage2D(self : access Inst;target_P : int;level_P : int;internalformat_P : int;width_P : int;height_P : int;border_P : int;format_P : int;type_K_P : int;pixels_P : int);
...
procedure glTexSubImage2D(self : access Inst;target_P : int;level_P : int;xoffset_P : int;yoffset_P : int;width_P : int;height_P : int;format_P : int;type_K_P : int;pixels_P : int);
...
procedure glUniformMatrix2fv(self : access Inst;location_P : int;count_P : int;transpose_P : int;value_P : Sequence_float);
procedure glUniformMatrix3fv(self : access Inst;location_P : int;count_P : int;transpose_P : int;value_P : Sequence_float);
procedure glUniformMatrix4fv(self : access Inst;location_P : int;count_P : int;transpose_P : int;value_P : Sequence_float);
...
procedure glVertexAttribPointer(self : access Inst;indx_P : int;size_P : int;type_K_P : int;normalized_P : int;stride_P : int;ptr_P : int);
procedure glViewport(self : access Inst;x_P : int;y_P : int;width_P : int;height_P : int);
function hasOpenGLFeature(self : access Inst;feature_P : access QtAda6.QtGui.QOpenGLFunctions.OpenGLFeature.Inst'Class) return bool;
