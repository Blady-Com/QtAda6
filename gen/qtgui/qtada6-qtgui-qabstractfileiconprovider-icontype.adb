...
package body QtAda6.QtGui.QAbstractFileIconProvider.IconType is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Computer"));
   end Computer;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAbstractFileIconProvider");
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Trashcan"));
   end Trashcan;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAbstractFileIconProvider");
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Network"));
   end Network;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAbstractFileIconProvider");
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Drive"));
   end Drive;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAbstractFileIconProvider");
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Folder"));
   end Folder;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAbstractFileIconProvider");
      Enum_Class   := Object_GetAttrString (Parent_Class, "IconType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "File"));
   end File;
