...
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QLinearGradient");
  Args   := Tuple_New ( 1);
  Tuple_SetItem (Args, 0,QLinearGradient_P.Python_Proxy);
  return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
end;
function Create(start_P : Union_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint_QtAda6_QtGui_QPainterPath_Element;finalStop_P : Union_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint_QtAda6_QtGui_QPainterPath_Element) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QLinearGradient");
  Args   := Tuple_New ( 2);
...
procedure setFinalStop(self : access Inst;stop_P : Union_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint_QtAda6_QtGui_QPainterPath_Element) is
  Method, Args, Result : Handle;
begin
...
procedure setStart(self : access Inst;start_P : Union_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint_QtAda6_QtGui_QPainterPath_Element) is
  Method, Args, Result : Handle;
begin
