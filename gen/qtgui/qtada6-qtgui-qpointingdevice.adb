...
package body QtAda6.QtGui.QPointingDevice is
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, devType_P.Python_Proxy);
      Tuple_SetItem (Args, 3, pType_P.Python_Proxy);
      Tuple_SetItem (Args, 4, caps_P.Python_Proxy);
      ...
      Tuple_SetItem (Args, 8, uniqueId_P.Python_Proxy);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, caps_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setCapabilities;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, devType_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setType;
