...
function Create(device_P : access QtAda6.QtCore.QIODevice.Inst'Class;format_P : Union_QtAda6_QtCore_QByteArray_bytes;parent_P : Optional_QtAda6_QtCore_QObject) return Class is
  Class, Args : Handle;
begin
...
function Create(fileName_P : str;format_P : Union_QtAda6_QtCore_QByteArray_bytes;parent_P : Optional_QtAda6_QtCore_QObject) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QMovie");
  Args   := Tuple_New ( 3);
...
function lastError(self : access Inst) return access QtAda6.QtGui.QImageReader.ImageReaderError.Inst'Class is
  Method, Args, Result : Handle;
  Ret : constant QtAda6.QtGui.QImageReader.ImageReaderError.Class := new QtAda6.QtGui.QImageReader.ImageReaderError.Inst;
begin
...
procedure setBackgroundColor(self : access Inst;color_P : Union_QtAda6_QtGui_QColor_QtAda6_QtGui_QRgba64_Any_QtAda6_QtCore_Qt_GlobalColor_str_int) is
  Method, Args, Result : Handle;
begin
