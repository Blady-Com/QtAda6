...
actionChanged:ClassVar_Signal;-- actionChanged(Qt::DropAction)
targetChanged:ClassVar_Signal;-- targetChanged(QObject*)
...
function dragCursor(self : access Inst;action_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class) return access QtAda6.QtGui.QPixmap.Inst'Class;
function exec(self : access Inst;supportedActions_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class;defaultAction_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class) return access QtAda6.QtCore.Qt.DropAction.Inst'Class;
function exec(self : access Inst;supportedActions_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class) return access QtAda6.QtCore.Qt.DropAction.Inst'Class;
function exec_U(self : access Inst;arg_1_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class;arg_2_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class) return access QtAda6.QtCore.Qt.DropAction.Inst'Class;
function exec_U(self : access Inst;supportedActions_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class) return access QtAda6.QtCore.Qt.DropAction.Inst'Class;
...
procedure setDragCursor(self : access Inst;cursor_P : Union_QtAda6_QtGui_QPixmap_QtAda6_QtGui_QImage_str;action_P : access QtAda6.QtCore.Qt.DropAction.Inst'Class);
