...
package body QtAda6.QtGui.QFontInfo is
   ...
   function Create (arg_1_P : UNION_QtAda6_QtGui_QFontInfoQtAda6_QtGui_QFont) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QFontInfo");
      Args  := Tuple_New (1);
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtGui_QFontInfoQtAda6_QtGui_QFont) is
      Method, Args, List, Result : Handle;
   begin
