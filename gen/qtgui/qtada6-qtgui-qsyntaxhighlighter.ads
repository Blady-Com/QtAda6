...
procedure setFormat(self : access Inst;start_P : int;count_P : int;color_P : Union_QtAda6_QtGui_QColor_QtAda6_QtGui_QRgba64_Any_QtAda6_QtCore_Qt_GlobalColor_str_int);
procedure setFormat(self : access Inst;start_P : int;count_P : int;font_P : Union_QtAda6_QtGui_QFont_str_Sequence_str);
procedure setFormat(self : access Inst;start_P : int;count_P : int;format_P : access QtAda6.QtGui.QTextCharFormat.Inst'Class);
