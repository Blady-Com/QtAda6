...
package QtAda6.QtGui.QDoubleValidator is
   ...
   function bottomChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- bottomChanged(double)
   function decimalsChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- decimalsChanged(int)
   function notationChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- notationChanged(QDoubleValidator::Notation)
   function topChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- topChanged(double)
   function Create
