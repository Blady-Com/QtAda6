...
package body QtAda6.QtGui.QVector3D is
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, point_P.Python_Proxy);
      Tuple_SetItem (Args, 1, direction_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Args   := Tuple_New (3);
      Tuple_SetItem (Args, 0, plane1_P.Python_Proxy);
      Tuple_SetItem (Args, 1, plane2_P.Python_Proxy);
      Tuple_SetItem (Args, 2, plane3_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
      return Float_AsDouble (Result);
   end distanceToPlane;
   function distanceToPlane
   ...
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "distanceToPlane");
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, plane_P.Python_Proxy);
      Tuple_SetItem (Args, 1, normal_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
      return Float_AsDouble (Result);
   end distanceToPlane;
   ...
   begin
      ...
      Tuple_SetItem (Args, 0, v1_P.Python_Proxy);
      Tuple_SetItem (Args, 1, v2_P.Python_Proxy);
      Tuple_SetItem (Args, 2, v3_P.Python_Proxy);
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end normal;
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, viewport_P.Python_Proxy);
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end project;
