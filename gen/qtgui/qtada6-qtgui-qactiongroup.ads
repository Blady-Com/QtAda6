...
function addAction(self : access Inst;a_P : access QtAda6.QtGui.QAction.Inst'Class) return access QtAda6.QtGui.QAction.Inst'Class;
function addAction(self : access Inst;icon_P : Union_QtAda6_QtGui_QIcon_QtAda6_QtGui_QPixmap;text_P : str) return access QtAda6.QtGui.QAction.Inst'Class;
...
procedure setExclusionPolicy(self : access Inst;policy_P : access QtAda6.QtGui.QActionGroup.ExclusionPolicy.Inst'Class);
