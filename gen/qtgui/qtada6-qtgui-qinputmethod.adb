...
package body QtAda6.QtGui.QInputMethod is
   ...
   function anchorRectangleChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function animatingChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "animatingChanged"));
   end animatingChanged;
   function cursorRectangleChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "cursorRectangleChanged"));
   end cursorRectangleChanged;
   function inputDirectionChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "inputDirectionChanged"));
   end inputDirectionChanged;
   function inputItemClipRectangleChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "inputItemClipRectangleChanged"));
   end inputItemClipRectangleChanged;
   function keyboardRectangleChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "keyboardRectangleChanged"));
   end keyboardRectangleChanged;
   function localeChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
   ...
   procedure setInputItemRectangle (self : access Inst; rect_P : access QtAda6.QtCore.QRectF.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setInputItemRectangle (self : access Inst; rect_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setInputItemRectangle");
      Args   := Tuple_New (1);
