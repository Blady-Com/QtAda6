...
package body QtAda6.QtGui.QAccessibleTextInterface is
   ...
   function attributes (self : access Inst; offset_P : int) return TUPLE_strintint is
      Method, Args, List, Result : Handle;
   begin
   ...
   function selection (self : access Inst; selectionIndex_P : int) return TUPLE_intint is
      Method, Args, List, Result : Handle;
   begin
