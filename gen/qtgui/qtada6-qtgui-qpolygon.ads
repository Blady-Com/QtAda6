...
package QtAda6.QtGui.QPolygon is
   ...
   function Create (QPolygon_P : access QtAda6.QtGui.QPolygon.Inst'Class) return Class;
   function Create (QPolygon_P : SEQUENCE_QtAda6_QtCore_QRect) return Class;
   ...
   function intersects (self : access Inst; r_P : SEQUENCE_QtAda6_QtCore_QRect) return bool;
   ...
   function mid (self : access Inst; pos_P : int; len_P : int := 0) return LIST_QtAda6_QtCore_QPoint;
   ...
   procedure swap (self : access Inst; other_P : SEQUENCE_QtAda6_QtCore_QRect);
