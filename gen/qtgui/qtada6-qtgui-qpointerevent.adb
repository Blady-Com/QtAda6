...
package body QtAda6.QtGui.QPointerEvent is
   ...
   function Create
     (type_K_P : access QtAda6.QtCore.QEvent.Type_K.Inst'Class; dev_P : access QtAda6.QtGui.QPointingDevice.Inst'Class;
      modifiers_P : access QtAda6.QtCore.Qt.KeyboardModifier.Inst'Class; points_P : Sequence_QtAda6_QtGui_QEventPoint)
      return Class
   is
      Class, Args : Handle;
   begin
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, grabber_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, point_P.Python_Proxy);
      Tuple_SetItem (Args, 1, exclusiveGrabber_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
