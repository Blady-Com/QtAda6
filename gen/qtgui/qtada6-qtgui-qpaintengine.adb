...
package body QtAda6.QtGui.QPaintEngine is
   ...
   procedure setSystemClip (self : access Inst; baseClip_P : access QtAda6.QtGui.QRegion.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setSystemClip (self : access Inst; baseClip_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setSystemClip");
      Args   := Tuple_New (1);
   ...
   procedure setSystemClip (self : access Inst; baseClip_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setSystemClip");
      Args   := Tuple_New (1);
   ...
   procedure setSystemClip (self : access Inst; baseClip_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setSystemClip");
      Args   := Tuple_New (1);
