...
package body QtAda6.QtGui.QQuaternion is
   ...
   begin
      ...
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Ret : TUPLE_float_float_float_float do
         Ret.C0 := Float_AsDouble (Tuple_GetItem (Result, 0));
         Ret.C1 := Float_AsDouble (Tuple_GetItem (Result, 1));
         Ret.C2 := Float_AsDouble (Tuple_GetItem (Result, 2));
         Ret.C3 := Float_AsDouble (Tuple_GetItem (Result, 3));
      end return;
   end getAxisAndAngle;
   ...
   begin
      ...
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Ret : TUPLE_float_float_float do
         Ret.C0 := Float_AsDouble (Tuple_GetItem (Result, 0));
         Ret.C1 := Float_AsDouble (Tuple_GetItem (Result, 1));
         Ret.C2 := Float_AsDouble (Tuple_GetItem (Result, 2));
      end return;
