...
package body QtAda6.QtGui.QFont is
   ...
   function Create (font_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QFont");
      Args  := Tuple_New (1);
   ...
   function Create
     (font_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str; pd_P : access QtAda6.QtGui.QPaintDevice.Inst'Class) return Class
   is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QFont");
   ...
   function isCopyOf (self : access Inst; arg_1_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   function resolve
     (self : access Inst; arg_1_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str) return access QtAda6.QtGui.QFont.Inst'Class
   is
      Method, Args, List, Result : Handle;
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, (if arg_1_P /= null then arg_1_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 1, (if strategy_P /= null then strategy_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
   end setStyleHint;
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str) is
      Method, Args, List, Result : Handle;
   begin
