...
package QtAda6.QtGui.QStaticText is
   ...
   procedure setTextOption (self : access Inst; textOption_P : access QtAda6.QtGui.QTextOption.Inst'Class);
   procedure setTextOption (self : access Inst; textOption_P : access QtAda6.QtCore.Qt.AlignmentFlag.Inst'Class);
