...
package QtAda6.QtGui.QGradient is
   ...
   type SEQUENCE_TUPLE_floatQtAda6_QtGui_QColor is array (Positive range <>) of TUPLE_float_QtAda6_QtGui_QColor;
   type LIST_TUPLE_floatQtAda6_QtGui_QColor is array (Positive range <>) of TUPLE_float_QtAda6_QtGui_QColor;
   procedure Finalize (Self : in out Class);
   function Create return Class;
   function Create (QGradient_P : UNION_QtAda6_QtGui_QGradientQtAda6_QtGui_QGradient_Preset) return Class;
   ...
   procedure setStops (self : access Inst; stops_P : SEQUENCE_TUPLE_floatQtAda6_QtGui_QColor);
   function spread_F (self : access Inst) return access QtAda6.QtGui.QGradient.Spread.Inst'Class;
   function stops (self : access Inst) return LIST_TUPLE_floatQtAda6_QtGui_QColor;
