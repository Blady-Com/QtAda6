...
--  and QtAda6.QtGui.QPagedPaintDevice.Inst
   ...
   procedure addFileAttachment
     (self       : access Inst; fileName_P : str; data_P : access QtAda6.QtCore.QByteArray.Inst'Class;
      mimeType_P : str := "");
   procedure addFileAttachment (self : access Inst; fileName_P : str; data_P : bytes; mimeType_P : str := "");
   ...
   function metric
     (self : access Inst; id_P : access QtAda6.QtGui.QPaintDevice.PaintDeviceMetric.Inst'Class) return int;
   ...
   procedure setDocumentXmpMetadata (self : access Inst; xmpMetadata_P : access QtAda6.QtCore.QByteArray.Inst'Class);
   procedure setDocumentXmpMetadata (self : access Inst; xmpMetadata_P : bytes);
