...
function Create(iface_P : access QtAda6.QtGui.QAccessibleInterface.Inst'Class;position_P : int;oldText_P : str;text_P : str) return Class is
  Class, Args : Handle;
begin
...
function Create(obj_P : access QtAda6.QtCore.QObject.Inst'Class;position_P : int;oldText_P : str;text_P : str) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QAccessibleTextUpdateEvent");
  Args   := Tuple_New ( 4);
