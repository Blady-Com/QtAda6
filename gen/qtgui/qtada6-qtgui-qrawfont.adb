...
package body QtAda6.QtGui.QRawFont is
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if antialiasingType_P /= null then antialiasingType_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 2, (if transform_P /= null then transform_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if writingSystem_P /= null then writingSystem_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end fromFont;
