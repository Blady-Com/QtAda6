...
package body QtAda6.QtGui.QTextDocument.Stacks is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UndoStack"));
   end UndoStack;
   function RedoStack return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QTextDocument");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "RedoStack"));
   end RedoStack;
   function UndoAndRedoStacks return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QTextDocument");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UndoAndRedoStacks"));
