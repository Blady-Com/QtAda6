...
package body QtAda6.QtGui.QColor is
   ...
   function Create (r_P : int; g_P : int; b_P : int; a_P : int := 255) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColor");
      Args  := Tuple_New (4);
   ...
   function Create
     (spec_P : access QtAda6.QtGui.QColor.Spec.Inst'Class; a1_P : int; a2_P : int; a3_P : int; a4_P : int; a5_P : int)
      return Class
   is
      Class, Args : Handle;
   begin
   ...
   function U_setstate_U (self : access Inst; arg_1_P : Object) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, colorSpec_P.Python_Proxy);
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end convertTo;
   ...
   function darker (self : access Inst; f_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Method, Args, Result : Handle;
      Ret                  : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromCmyk
     (c_P : int; m_P : int; y_P : int; k_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class
   is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromCmykF
     (c_P : float; m_P : float; y_P : float; k_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class
   is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromHsl (h_P : int; s_P : int; l_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
      Class  := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColor");
   ...
   function fromHslF (h_P : float; s_P : float; l_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class
   is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromHsv (h_P : int; s_P : int; v_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
      Class  := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColor");
   ...
   function fromHsvF (h_P : float; s_P : float; v_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class
   is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromRgb (r_P : int; g_P : int; b_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
      Class  := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColor");
   ...
   function fromRgbF (r_P : float; g_P : float; b_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class
   is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function fromRgba64 (r_P : int; g_P : int; b_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Class, Method, Args, Result : Handle;
      Ret                         : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
      Class  := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QColor");
   ...
   begin
      ...
      Method := Object_GetAttrString (Class, "fromRgba64");
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, rgba_P.Python_Proxy);
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end fromRgba64;
   ...
   function getCmyk (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getCmykF (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getHsl (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getHslF (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getHsv (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getHsvF (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getRgb (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function getRgbF (self : access Inst) return Object is
      Method, Args, Result : Handle;
   begin
   ...
   function lighter (self : access Inst; f_P : int) return access QtAda6.QtGui.QColor.Inst'Class is
      Method, Args, Result : Handle;
      Ret                  : constant QtAda6.QtGui.QColor.Class := new QtAda6.QtGui.QColor.Inst;
   begin
   ...
   function name_F (self : access Inst; format_P : access QtAda6.QtGui.QColor.NameFormat.Inst'Class) return str is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setCmyk (self : access Inst; c_P : int; m_P : int; y_P : int; k_P : int; a_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setCmykF (self : access Inst; c_P : float; m_P : float; y_P : float; k_P : float; a_P : float) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setHsl (self : access Inst; h_P : int; s_P : int; l_P : int; a_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setHslF (self : access Inst; h_P : float; s_P : float; l_P : float; a_P : float) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setHsv (self : access Inst; h_P : int; s_P : int; v_P : int; a_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setHsvF (self : access Inst; h_P : float; s_P : float; v_P : float; a_P : float) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setRgb (self : access Inst; r_P : int; g_P : int; b_P : int; a_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setRgbF (self : access Inst; r_P : float; g_P : float; b_P : float; a_P : float) is
      Method, Args, Result : Handle;
   begin
