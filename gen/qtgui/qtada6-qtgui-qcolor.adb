...
package body QtAda6.QtGui.QColor is
   ...
   begin
      ...
      Dict := Dict_New;
      if a_P /= 0 then
         Dict_SetItemString (Dict, "a", Long_FromLong (a_P));
      end if;
      return new Inst'(Python_Proxy => Object_Call (Class, Args, Dict, True));
   end Create;
   ...
   begin
      ...
      Dict := Dict_New;
      if a5_P /= 0 then
         Dict_SetItemString (Dict, "a5", Long_FromLong (a5_P));
      end if;
      return new Inst'(Python_Proxy => Object_Call (Class, Args, Dict, True));
   end Create;
   ...
   begin
      ...
      Dict   := Dict_New;
      if f_P /= 0 then
         Dict_SetItemString (Dict, "f", Long_FromLong (f_P));
      end if;
      Result           := Object_Call (Method, Args, Dict, True);
      Ret.Python_Proxy := Result;
      return Ret;
   ...
   begin
      ...
      Dict := Dict_New;
      if a_P /= 0.0 then
         Dict_SetItemString (Dict, "a", Float_FromDouble (a_P));
      end if;
      Result           := Object_Call (Method, Args, Dict, True);
      Ret.Python_Proxy := Result;
      return Ret;
   ...
   function name (self : access Inst; format_P : access QtAda6.QtGui.QColor.NameFormat.Inst'Class := null) return str is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
