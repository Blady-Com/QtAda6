...
package body QtAda6.QtGui.QBackingStore is
   ...
   procedure beginPaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QRegion.Inst'Class) is
   ...
   procedure beginPaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "beginPaint");
      Args   := Tuple_New (1);
   ...
   procedure beginPaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "beginPaint");
      Args   := Tuple_New (1);
   ...
   procedure beginPaint (self : access Inst; arg_1_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "beginPaint");
      Args   := Tuple_New (1);
   ...
   procedure setStaticContents (self : access Inst; region_P : access QtAda6.QtGui.QRegion.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setStaticContents (self : access Inst; region_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setStaticContents");
      Args   := Tuple_New (1);
   ...
   procedure setStaticContents (self : access Inst; region_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setStaticContents");
      Args   := Tuple_New (1);
   ...
   procedure setStaticContents (self : access Inst; region_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setStaticContents");
      Args   := Tuple_New (1);
