...
package body QtAda6.QtGui.QPicture is
   ...
   function Create (arg_1_P : UNION_QtAda6_QtGui_QPictureint) return Class is
   ...
   function Create (formatVersion_P : int := 0) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QPicture");
      Args  := Tuple_New (1);
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtGui_QPictureint) is
      Method, Args, List, Result : Handle;
   begin
