...
package body QtAda6.QtGui.QRegion is
   ...
   function Create (bitmap_P : UNION_QtAda6_QtGui_QBitmapstr) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QRegion");
      Args  := Tuple_New (1);
   ...
   function Create
     (pa_P       : UNION_QtAda6_QtGui_QPolygonSEQUENCE_QtAda6_QtCore_QRect;
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if t_P /= null then t_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create
     (region_P : UNION_QtAda6_QtGui_QRegionQtAda6_QtGui_QBitmapQtAda6_QtGui_QPolygonQtAda6_QtCore_QRect) return Class
   is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QRegion");
   ...
   begin
      ...
      Tuple_SetItem (Args, 4, (if t_P /= null then t_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function U_add_U
   ...
   procedure swap
     (self    : access Inst;
      other_P : UNION_QtAda6_QtGui_QRegionQtAda6_QtGui_QBitmapQtAda6_QtGui_QPolygonQtAda6_QtCore_QRect)
   is
      Method, Args, List, Result : Handle;
   begin
