...
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QMatrix3x4");
  Args   := Tuple_New ( 1);
  Tuple_SetItem (Args, 0,QMatrix3x4_P.Python_Proxy);
  return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
end;
...
function U_iadd_U(self : access Inst;other_P : access QtAda6.QtGui.QMatrix3x4.Inst'Class) return access QtAda6.QtGui.QMatrix3x4.Inst'Class is
  Method, Args, Result : Handle;
...
function U_isub_U(self : access Inst;other_P : access QtAda6.QtGui.QMatrix3x4.Inst'Class) return access QtAda6.QtGui.QMatrix3x4.Inst'Class is
  Method, Args, Result : Handle;
  Ret : constant QtAda6.QtGui.QMatrix3x4.Class := new QtAda6.QtGui.QMatrix3x4.Inst;
begin
