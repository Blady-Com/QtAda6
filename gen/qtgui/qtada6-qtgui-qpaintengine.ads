...
package QtAda6.QtGui.QPaintEngine is
   ...
   function createPixmapFromImage
     (self    : access Inst; image_P : UNION_QtAda6_QtGui_QImagestr;
   ...
   procedure drawImage
     (self    : access Inst; r_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect; pm_P : UNION_QtAda6_QtGui_QImagestr;
      sr_P    : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect;
      flags_P : access QtAda6.QtCore.Qt.ImageConversionFlag.Inst'Class := null);
   ...
   procedure drawTiledPixmap
     (self     : access Inst; r_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect;
      ...
      s_P      : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPointQtAda6_QtGui_QPainterPath_Element);
   ...
   procedure setSystemClip
     (self       : access Inst;
      baseClip_P : UNION_QtAda6_QtGui_QRegionQtAda6_QtGui_QBitmapQtAda6_QtGui_QPolygonQtAda6_QtCore_QRect);
