...
package QtAda6.QtGui.QPageLayout is
   ...
   function setMargins (self : access Inst; margins_P : access QtAda6.QtCore.QMarginsF.Inst'Class) return bool;
   function setMargins (self : access Inst; margins_P : access QtAda6.QtCore.QMargins.Inst'Class) return bool;
   procedure setMinimumMargins (self : access Inst; minMargins_P : access QtAda6.QtCore.QMarginsF.Inst'Class);
   procedure setMinimumMargins (self : access Inst; minMargins_P : access QtAda6.QtCore.QMargins.Inst'Class);
