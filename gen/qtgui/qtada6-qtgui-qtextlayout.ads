...
--  procedure draw(self : access Inst;p_P : access QtAda6.QtGui.QPainter.Inst'Class;pos_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPointQtAda6_QtGui_QPainterPath_Element;selections_P : SEQUENCE_QtAda6_QtGui_QTextLayout_FormatRange := (2..1 => <>);clip_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect := null);
