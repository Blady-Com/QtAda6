...
package body QtAda6.QtGui.QMatrix3x2 is
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QMatrix3x2");
      Args  := Tuple_New (1);
      Tuple_SetItem (Args, 0, (if QMatrix3x2_P /= null then QMatrix3x2_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   function U_iadd_U
     (self : access Inst; other_P : access QtAda6.QtGui.QMatrix3x2.Inst'Class)
      return access QtAda6.QtGui.QMatrix3x2.Inst'Class
   is
      Method, Args, List, Result : Handle;
