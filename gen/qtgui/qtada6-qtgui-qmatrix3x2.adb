-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtgui-qmatrix3x2.adb
...
with QtAda6.QtGui.QMatrix2x3;
package body QtAda6.QtGui.QMatrix3x2 is
...
function Create return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QMatrix3x2");
  Args   := Tuple_New ( 0);
  return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
end;
function Create(QMatrix3x2_P : access QtAda6.QtGui.QMatrix3x2.Inst'Class) return Class is
  Class, Args : Handle;
begin
  Class := Object_GetAttrString (QtAda6.QtGui_Python_Proxy, "QMatrix3x2");
  Args   := Tuple_New ( 1);
  Tuple_SetItem (Args, 0,QMatrix3x2_P.Python_Proxy);
  return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
end;
...
function U_iadd_U(self : access Inst;other_P : access QtAda6.QtGui.QMatrix3x2.Inst'Class) return access QtAda6.QtGui.QMatrix3x2.Inst'Class is
  Method, Args, Result : Handle;
...
function U_imul_U(self : access Inst;factor_P : float) return access QtAda6.QtGui.QMatrix3x2.Inst'Class is
  Method, Args, Result : Handle;
  Ret : constant QtAda6.QtGui.QMatrix3x2.Class := new QtAda6.QtGui.QMatrix3x2.Inst;
begin
...
function U_isub_U(self : access Inst;other_P : access QtAda6.QtGui.QMatrix3x2.Inst'Class) return access QtAda6.QtGui.QMatrix3x2.Inst'Class is
  Method, Args, Result : Handle;
  Ret : constant QtAda6.QtGui.QMatrix3x2.Class := new QtAda6.QtGui.QMatrix3x2.Inst;
begin
...
function transposed(self : access Inst) return access QtAda6.QtGui.QMatrix2x3.Inst'Class is
  Method, Args, Result : Handle;
