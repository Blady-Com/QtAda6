-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtgui-qaction-actionevent.adb
...
package body QtAda6.QtGui.QAction.ActionEvent is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "ActionEvent");
