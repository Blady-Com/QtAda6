...
package QtAda6.QtGui.QColor is
   ...
   function Create (r_P : int; g_P : int; b_P : int; a_P : int := 255) return Class;
   ...
   function U_rshift_U
     (self : access Inst; arg_1_P : access QtAda6.QtCore.QDataStream.Inst'Class)
      return access QtAda6.QtCore.QDataStream.Inst'Class;
   function U_setstate_U (self : access Inst; arg_1_P : Object) return Object;
   ...
   function darker (self : access Inst; f_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   function fromCmyk
   ...
   function fromHsl (h_P : int; s_P : int; l_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   function fromHslF (h_P : float; s_P : float; l_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class;
   function fromHsv (h_P : int; s_P : int; v_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   function fromHsvF (h_P : float; s_P : float; v_P : float; a_P : float) return access QtAda6.QtGui.QColor.Inst'Class;
   function fromRgb (r_P : int; g_P : int; b_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   ...
   function fromRgba64 (r_P : int; g_P : int; b_P : int; a_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   ...
   function getCmyk (self : access Inst) return Object;
   function getCmykF (self : access Inst) return Object;
   function getHsl (self : access Inst) return Object;
   function getHslF (self : access Inst) return Object;
   function getHsv (self : access Inst) return Object;
   function getHsvF (self : access Inst) return Object;
   function getRgb (self : access Inst) return Object;
   function getRgbF (self : access Inst) return Object;
...
-- function isValidColor(name_P : str) return bool;
   ...
   function lighter (self : access Inst; f_P : int) return access QtAda6.QtGui.QColor.Inst'Class;
   ...
   function name_F (self : access Inst; format_P : access QtAda6.QtGui.QColor.NameFormat.Inst'Class) return str;
   ...
   procedure setCmyk (self : access Inst; c_P : int; m_P : int; y_P : int; k_P : int; a_P : int);
   procedure setCmykF (self : access Inst; c_P : float; m_P : float; y_P : float; k_P : float; a_P : float);
   procedure setGreen (self : access Inst; green_P : int);
   procedure setGreenF (self : access Inst; green_P : float);
   procedure setHsl (self : access Inst; h_P : int; s_P : int; l_P : int; a_P : int);
   procedure setHslF (self : access Inst; h_P : float; s_P : float; l_P : float; a_P : float);
   procedure setHsv (self : access Inst; h_P : int; s_P : int; v_P : int; a_P : int);
   procedure setHsvF (self : access Inst; h_P : float; s_P : float; v_P : float; a_P : float);
   ...
   procedure setRgb (self : access Inst; r_P : int; g_P : int; b_P : int; a_P : int);
   procedure setRgb (self : access Inst; rgb_P : int);
   procedure setRgbF (self : access Inst; r_P : float; g_P : float; b_P : float; a_P : float);
