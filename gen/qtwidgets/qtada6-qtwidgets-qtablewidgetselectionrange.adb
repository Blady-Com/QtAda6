-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtwidgets-qtablewidgetselectionrange.adb
...
package body QtAda6.QtWidgets.QTableWidgetSelectionRange is
   ...
   begin
      ...
      Tuple_SetItem
        (Args, 0,
         (if QTableWidgetSelectionRange_P /= null then QTableWidgetSelectionRange_P.Python_Proxy else No_Value));
      Dict := Dict_New;
      return new Inst'(Python_Proxy => Object_Call (Class, Args, Dict, True));
   end Create;
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, Long_FromLong (left_P));
      Tuple_SetItem (Args, 2, Long_FromLong (bottom_P));
      Tuple_SetItem (Args, 3, Long_FromLong (right_P));
      Dict := Dict_New;
      return new Inst'(Python_Proxy => Object_Call (Class, Args, Dict, True));
   end Create;
