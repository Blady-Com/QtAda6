...
package body QtAda6.QtWidgets.QAbstractItemView.SelectionMode is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "SelectionMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NoSelection"));
   end NoSelection;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QAbstractItemView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "SelectionMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "SingleSelection"));
   end SingleSelection;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QAbstractItemView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "SelectionMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "MultiSelection"));
   end MultiSelection;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QAbstractItemView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "SelectionMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ExtendedSelection"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QAbstractItemView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "SelectionMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ContiguousSelection"));
