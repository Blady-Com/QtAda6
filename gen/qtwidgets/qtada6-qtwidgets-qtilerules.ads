...
package QtAda6.QtWidgets.QTileRules is
   ...
   function Create (QTileRules_P : access QtAda6.QtWidgets.QTileRules.Inst'Class) return Class;
   function Create (QTileRules_P : access QtAda6.QtCore.Qt.TileRule.Inst'Class) return Class;
   function Create
