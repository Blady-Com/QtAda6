...
package QtAda6.QtWidgets.QAbstractItemDelegate is
   ...
   closeEditor     : ClassVar_Signal;-- closeEditor(QWidget*,QAbstractItemDelegate::EndEditHint)
   commitData      : ClassVar_Signal;-- commitData(QWidget*)
   sizeHintChanged : ClassVar_Signal;-- sizeHintChanged(QModelIndex)
