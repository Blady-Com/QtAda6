...
package QtAda6.QtWidgets.QDockWidget is
   ...
   function allowedAreasChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- allowedAreasChanged(Qt::DockWidgetAreas)
   function dockLocationChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- dockLocationChanged(Qt::DockWidgetArea)
   function featuresChanged
     (self : access Inst)
      return access QtAda6.QtCore.Signal.Inst'Class;-- featuresChanged(QDockWidget::DockWidgetFeatures)
