...
package body QtAda6.QtWidgets.QTabBar is
   ...
   function tabBarClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "tabBarClicked"));
   end tabBarClicked;
   function tabBarDoubleClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function tabCloseRequested (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "tabCloseRequested"));
   end tabCloseRequested;
   function tabMoved (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
