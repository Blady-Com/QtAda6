...
package body QtAda6.QtWidgets.QGraphicsScene is
   ...
   function Create
     (sceneRect_P : UNION_QtAda6_QtCore_QRectF_QtAda6_QtCore_QRect;
   ...
   function addEllipse
     (self    : access Inst; rect_P : UNION_QtAda6_QtCore_QRectF_QtAda6_QtCore_QRect;
      pen_P   : UNION_QtAda6_QtGui_QPen_QtAda6_QtCore_Qt_PenStyle_QtAda6_QtGui_QColor := null;
   ...
   function addSimpleText
     (self : access Inst; text_P : str; font_P : UNION_QtAda6_QtGui_QFont_str_SEQUENCE_str := null)
   ...
   procedure render
     (self              : access Inst; painter_P : access QtAda6.QtGui.QPainter.Inst'Class;
      ...
      source_P          : UNION_QtAda6_QtCore_QRectF_QtAda6_QtCore_QRect     := null;
   ...
   procedure update (self : access Inst; rect_P : UNION_QtAda6_QtCore_QRectF_QtAda6_QtCore_QRect := null) is
      Method, Args, Dict, List, Tuple, Result : Handle;
   begin
