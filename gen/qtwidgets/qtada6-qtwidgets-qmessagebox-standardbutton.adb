...
package body QtAda6.QtWidgets.QMessageBox.StandardButton is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ButtonMask"));
   end ButtonMask;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMessageBox");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StandardButton");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Escape"));
   end Escape;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMessageBox");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StandardButton");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "FlagMask"));
   end FlagMask;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMessageBox");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StandardButton");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "YesAll"));
   end YesAll;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMessageBox");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StandardButton");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NoAll"));
   end NoAll;
