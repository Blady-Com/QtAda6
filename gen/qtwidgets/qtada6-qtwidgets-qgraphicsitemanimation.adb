...
package body QtAda6.QtWidgets.QGraphicsItemAnimation is
   ...
   function posList (self : access Inst) return LIST_TUPLE_floatQtAda6_QtCore_QPointF is
      Method, Args, List, Result : Handle;
   begin
   ...
   function rotationList (self : access Inst) return LIST_TUPLE_floatfloat is
      Method, Args, List, Result : Handle;
   begin
   ...
   function scaleList (self : access Inst) return LIST_TUPLE_floatQtAda6_QtCore_QPointF is
      Method, Args, List, Result : Handle;
   begin
   ...
   function shearList (self : access Inst) return LIST_TUPLE_floatQtAda6_QtCore_QPointF is
      Method, Args, List, Result : Handle;
   begin
   ...
   function translationList (self : access Inst) return LIST_TUPLE_floatQtAda6_QtCore_QPointF is
      Method, Args, List, Result : Handle;
   begin
