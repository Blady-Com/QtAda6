...
package body QtAda6.QtWidgets.QStatusBar is
   ...
   procedure addWidget (self : access Inst; widget_P : access QtAda6.QtWidgets.QWidget.Inst'Class; stretch_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure showMessage (self : access Inst; text_P : str; timeout_P : int) is
      Method, Args, Result : Handle;
   begin
