...
package body QtAda6.QtWidgets.QListWidgetItem is
   ...
   function Create (listview_P : Optional_QtAda6_QtWidgets_QListWidget; type_K_P : int) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QListWidgetItem");
      Args  := Tuple_New (2);
   ...
   function Create (text_P : str; listview_P : Optional_QtAda6_QtWidgets_QListWidget; type_K_P : int) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QListWidgetItem");
      Args  := Tuple_New (3);
