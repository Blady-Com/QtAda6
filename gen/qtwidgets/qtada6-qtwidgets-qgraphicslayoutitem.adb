...
package body QtAda6.QtWidgets.QGraphicsLayoutItem is
   ...
   function Create (parent_P : Optional_QtAda6_QtWidgets_QGraphicsLayoutItem; isLayout_P : bool) return Class is
      Class, Args : Handle;
   begin
   ...
   procedure setSizePolicy
     (self          : access Inst; hPolicy_P : access QtAda6.QtWidgets.QSizePolicy.Policy.Inst'Class;
      ...
      controlType_P : access QtAda6.QtWidgets.QSizePolicy.ControlType.Inst'Class)
   is
      Method, Args, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setSizePolicy");
      Args   := Tuple_New (3);
      Tuple_SetItem (Args, 0, hPolicy_P.Python_Proxy);
      Tuple_SetItem (Args, 1, vPolicy_P.Python_Proxy);
      Tuple_SetItem (Args, 2, controlType_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setSizePolicy;
