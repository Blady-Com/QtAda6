-------------------------------------------------------------------------------
-- NAME (spec)                  : qtada6-qtwidgets-qradiobutton.ads
...
package QtAda6.QtWidgets.QRadioButton is
   type Inst;
   ...
   function hitButton (self : access Inst; arg_1_P : access QtAda6.QtCore.QPoint.Inst'Class) return bool;
   procedure initStyleOption (self : access Inst; button_P : access QtAda6.QtWidgets.QStyleOptionButton.Inst'Class);
