...
package body QtAda6.QtWidgets.QTextEdit.AutoFormattingFlag is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "AutoFormattingFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "AutoNone"));
   end AutoNone;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTextEdit");
      Enum_Class   := Object_GetAttrString (Parent_Class, "AutoFormattingFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "AutoBulletList"));
   end AutoBulletList;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTextEdit");
      Enum_Class   := Object_GetAttrString (Parent_Class, "AutoFormattingFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "AutoAll"));
   end AutoAll;
