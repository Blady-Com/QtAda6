...
package QtAda6.QtWidgets.QGraphicsTextItem is
   ...
   procedure setDefaultTextColor (self : access Inst; c_P : access QtAda6.QtGui.QColor.Inst'Class);
   procedure setDefaultTextColor (self : access Inst; c_P : access QtAda6.QtGui.QRgba64.Inst'Class);
   procedure setDefaultTextColor (self : access Inst; c_P : Any);
   procedure setDefaultTextColor (self : access Inst; c_P : access QtAda6.QtCore.Qt.GlobalColor.Inst'Class);
   procedure setDefaultTextColor (self : access Inst; c_P : str);
   procedure setDefaultTextColor (self : access Inst; c_P : int);
