...
package body QtAda6.QtWidgets.QLineEdit is
   ...
   function inputRejected (self : access Inst) return CLASSVAR_Signal is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "inputRejected"));
   end inputRejected;
   function returnPressed (self : access Inst) return CLASSVAR_Signal is
   begin
   ...
   function textEdited (self : access Inst) return CLASSVAR_Signal is
   begin
