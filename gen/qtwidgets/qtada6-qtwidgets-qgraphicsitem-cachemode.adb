...
package body QtAda6.QtWidgets.QGraphicsItem.CacheMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NoCache"));
   end NoCache;
   function ItemCoordinateCache return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsItem");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ItemCoordinateCache"));
   end ItemCoordinateCache;
   function DeviceCoordinateCache return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsItem");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DeviceCoordinateCache"));
