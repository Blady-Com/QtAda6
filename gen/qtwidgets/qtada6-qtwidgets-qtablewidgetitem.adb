...
package body QtAda6.QtWidgets.QTableWidgetItem is
   ...
   function Create (icon_P : access QtAda6.QtGui.QIcon.Inst'Class; text_P : str; type_K_P : int := 0) return Class is
   ...
   function Create (icon_P : access QtAda6.QtGui.QPixmap.Inst'Class; text_P : str; type_K_P : int := 0) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTableWidgetItem");
      Args  := Tuple_New (2);
