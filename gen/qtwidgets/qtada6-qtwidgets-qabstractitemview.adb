...
package body QtAda6.QtWidgets.QAbstractItemView is
   ...
   function doubleClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "doubleClicked"));
   end doubleClicked;
   function entered (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
   ...
   function pressed (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "pressed"));
   end pressed;
   function viewportEntered (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
