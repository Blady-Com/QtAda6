...
package QtAda6.QtWidgets.QGraphicsPixmapItem is
   ...
   function Create
     (pixmap_P : access QtAda6.QtGui.QImage.Inst'Class;
      parent_P : access QtAda6.QtWidgets.QGraphicsItem.Inst'Class := null) return Class;
   function Create (pixmap_P : str; parent_P : access QtAda6.QtWidgets.QGraphicsItem.Inst'Class := null) return Class;
   ...
   procedure setOffset (self : access Inst; offset_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setOffset (self : access Inst; offset_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setOffset (self : access Inst; offset_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
