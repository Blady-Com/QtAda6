...
package body QtAda6.QtWidgets.QPlainTextEdit is
   ...
   function Create (text_P : str; parent_P : Optional_QtAda6_QtWidgets_QWidget) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QPlainTextEdit");
      Args  := Tuple_New (2);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, source_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
      return To_Ada (Result);
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, operation_P.Python_Proxy);
   ...
   procedure zoomIn (self : access Inst; range_K_P : int) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure zoomOut (self : access Inst; range_K_P : int) is
      Method, Args, Result : Handle;
   begin
