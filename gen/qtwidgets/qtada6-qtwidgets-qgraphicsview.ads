...
package QtAda6.QtWidgets.QGraphicsView is
   ...
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   ...
   procedure updateSceneRect (self : access Inst; rect_P : access QtAda6.QtCore.QRectF.Inst'Class);
   procedure updateSceneRect (self : access Inst; rect_P : access QtAda6.QtCore.QRect.Inst'Class);
