...
package body QtAda6.QtWidgets.QWizard is
   ...
   function currentIdChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "currentIdChanged"));
   end currentIdChanged;
   function customButtonClicked (self : access Inst) return CLASSVAR_Signal is
   begin
      return
