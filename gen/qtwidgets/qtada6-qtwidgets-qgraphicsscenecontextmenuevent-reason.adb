-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtwidgets-qgraphicsscenecontextmenuevent-reason.adb
...
package body QtAda6.QtWidgets.QGraphicsSceneContextMenuEvent.Reason is
   use type QtAda6.int;
   ...
   function Mouse return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsSceneContextMenuEvent");
