...
package body QtAda6.QtWidgets.QTreeWidgetItem is
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, after_P.Python_Proxy);
   ...
   function Create (parent_P : access QtAda6.QtWidgets.QTreeWidgetItem.Inst'Class; type_K_P : int) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTreeWidgetItem");
      Args  := Tuple_New (2);
   ...
   function Create (strings_P : Sequence_str; type_K_P : int) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTreeWidgetItem");
      Args  := Tuple_New (2);
   ...
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTreeWidgetItem");
      Args  := Tuple_New (3);
      Tuple_SetItem (Args, 0, treeview_P.Python_Proxy);
      Tuple_SetItem (Args, 1, after_P.Python_Proxy);
      Tuple_SetItem (Args, 2, Long_FromLong (type_K_P));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   function Create (treeview_P : access QtAda6.QtWidgets.QTreeWidget.Inst'Class; type_K_P : int) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QTreeWidgetItem");
      Args  := Tuple_New (2);
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, Long_FromLong (index_P));
      Tuple_SetItem (Args, 1, child_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end insertChild;
   ...
   procedure setFont (self : access Inst; column_P : int; font_P : Union_QtAda6_QtGui_QFont_str_Sequence_str) is
      Method, Args, Result : Handle;
   begin
   ...
   procedure setIcon (self : access Inst; column_P : int; icon_P : Union_QtAda6_QtGui_QIcon_QtAda6_QtGui_QPixmap) is
      Method, Args, Result : Handle;
   begin
