...
package QtAda6.QtWidgets.QGraphicsScene is
   ...
   type Sequence_QtAda6_QtWidgets_QGraphicsItem is access Any;
   ...
   type List_QtAda6_QtWidgets_QGraphicsView is access Any;
   type Inst;
   type Inst_Access is access all Inst;
   type Class is access all Inst'Class;
   type Inst is new QtAda6.QtCore.QObject.Inst with null record;
   procedure Finalize (Self : in out Class);
   changed          : ClassVar_Signal;-- changed(QList<QRectF>)
   focusItemChanged : ClassVar_Signal;-- focusItemChanged(QGraphicsItem*,QGraphicsItem*,Qt::FocusReason)
   sceneRectChanged : ClassVar_Signal;-- sceneRectChanged(QRectF)
