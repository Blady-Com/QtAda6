...
package QtAda6.QtWidgets.QSystemTrayIcon is
   ...
   function activated (self : access Inst) return CLASSVAR_Signal;-- activated(QSystemTrayIcon::ActivationReason)
   function messageClicked (self : access Inst) return CLASSVAR_Signal;-- messageClicked()
   function Create
