...
package body QtAda6.QtWidgets.QSpacerItem is
   ...
   function Create
     (w_P     : int; h_P : int; hData_P : access QtAda6.QtWidgets.QSizePolicy.Policy.Inst'Class;
      vData_P : access QtAda6.QtWidgets.QSizePolicy.Policy.Inst'Class) return Class
   is
      Class, Args : Handle;
   begin
      ...
      Tuple_SetItem (Args, 2, hData_P.Python_Proxy);
      Tuple_SetItem (Args, 3, vData_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   procedure changeSize
     (self    : access Inst; w_P : int; h_P : int; hData_P : access QtAda6.QtWidgets.QSizePolicy.Policy.Inst'Class;
      vData_P : access QtAda6.QtWidgets.QSizePolicy.Policy.Inst'Class)
   is
