...
package body QtAda6.QtWidgets.QDateTimeEdit is
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, parserType_P.Python_Proxy);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, section_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
      return As_String (Result);
   end sectionText;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, calendarWidget_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, max_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setMaximumDate;
