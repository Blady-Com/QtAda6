...
package body QtAda6.QtWidgets.QWizardPage is
   ...
   function completeChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, Bytes_FromString (String (property_P)));
      Tuple_SetItem (Args, 3, Bytes_FromString (String (changedSignal_P)));
      Result := Object_CallObject (Method, Args, True);
   end registerField;
