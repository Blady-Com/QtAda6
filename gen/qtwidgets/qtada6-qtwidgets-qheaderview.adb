...
package body QtAda6.QtWidgets.QHeaderView is
   ...
   function geometriesChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "geometriesChanged"));
   end geometriesChanged;
   function sectionClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionClicked"));
   end sectionClicked;
   function sectionCountChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function sectionDoubleClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
   ...
   function sectionEntered (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionEntered"));
   end sectionEntered;
   function sectionHandleDoubleClicked (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionHandleDoubleClicked"));
   end sectionHandleDoubleClicked;
   function sectionMoved (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionMoved"));
   end sectionMoved;
   function sectionPressed (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionPressed"));
   end sectionPressed;
   function sectionResized (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sectionResized"));
   end sectionResized;
   function sortIndicatorChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "sortIndicatorChanged"));
   end sortIndicatorChanged;
   function sortIndicatorClearableChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
