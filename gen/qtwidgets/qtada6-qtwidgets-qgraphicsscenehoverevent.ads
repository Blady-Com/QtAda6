...
package QtAda6.QtWidgets.QGraphicsSceneHoverEvent is
   ...
   procedure setLastPos (self : access Inst; pos_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setLastPos (self : access Inst; pos_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setLastPos (self : access Inst; pos_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure setLastScenePos (self : access Inst; pos_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setLastScenePos (self : access Inst; pos_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setLastScenePos (self : access Inst; pos_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
