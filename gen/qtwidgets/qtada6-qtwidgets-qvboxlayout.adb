-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtwidgets-qvboxlayout.adb
...
package body QtAda6.QtWidgets.QVBoxLayout is
   ...
   function Create return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QVBoxLayout");
      Args  := Tuple_New (0);
