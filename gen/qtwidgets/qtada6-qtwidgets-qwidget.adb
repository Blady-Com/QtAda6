...
package body QtAda6.QtWidgets.QWidget is
   ...
   function customContextMenuRequested (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   function windowIconChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "windowIconChanged"));
   end windowIconChanged;
   function windowIconTextChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, (if rectangle_P /= null then rectangle_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end grab;
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, (if sourceRegion_P /= null then sourceRegion_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 3, (if renderFlags_P /= null then renderFlags_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
   end render_F;
   procedure render_F
   ...
   function restoreGeometry (self : access Inst; geometry_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure setFont (self : access Inst; arg_1_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure setWindowIcon (self : access Inst; icon_P : UNION_QtAda6_QtGui_QIconQtAda6_QtGui_QPixmap) is
      Method, Args, List, Result : Handle;
   begin
