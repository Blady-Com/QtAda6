...
package body QtAda6.QtWidgets.QWidget is
   ...
   procedure grabMouse (self : access Inst; arg_1_P : access QtAda6.QtGui.QCursor.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "grabMouse");
      Args   := Tuple_New (1);
   ...
   procedure grabMouse (self : access Inst; arg_1_P : access QtAda6.QtCore.Qt.CursorShape.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "grabMouse");
      Args   := Tuple_New (1);
   ...
   procedure grabMouse (self : access Inst; arg_1_P : access QtAda6.QtGui.QPixmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "grabMouse");
      Args   := Tuple_New (1);
   ...
   function nativeEvent (self : access Inst; eventType_P : bytes; message_P : int) return access Object'Class is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "nativeEvent");
      Args   := Tuple_New (2);
   ...
   procedure repaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QRegion.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "repaint");
      Args   := Tuple_New (1);
   ...
   procedure repaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "repaint");
      Args   := Tuple_New (1);
   ...
   procedure repaint (self : access Inst; arg_1_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "repaint");
      Args   := Tuple_New (1);
   ...
   function restoreGeometry (self : access Inst; geometry_P : access QtAda6.QtCore.QByteArray.Inst'Class) return bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   function restoreGeometry (self : access Inst; geometry_P : bytes) return bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "restoreGeometry");
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, Bytes_FromString (Standard.String (geometry_P.all)));
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return To_Ada (Result);
   end restoreGeometry;
   ...
   procedure setCursor (self : access Inst; arg_1_P : access QtAda6.QtGui.QCursor.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setCursor (self : access Inst; arg_1_P : access QtAda6.QtCore.Qt.CursorShape.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setCursor");
      Args   := Tuple_New (1);
   ...
   procedure setCursor (self : access Inst; arg_1_P : access QtAda6.QtGui.QPixmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setCursor");
      Args   := Tuple_New (1);
   ...
   procedure setFont (self : access Inst; arg_1_P : access QtAda6.QtGui.QFont.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setFont (self : access Inst; arg_1_P : str) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setFont");
      Args   := Tuple_New (1);
   ...
   procedure setFont (self : access Inst; arg_1_P : SEQUENCE_str) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setFont");
      Args   := Tuple_New (1);
   ...
   procedure setMask (self : access Inst; arg_1_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setMask (self : access Inst; arg_1_P : str) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMask");
      Args   := Tuple_New (1);
   ...
   procedure setMask (self : access Inst; arg_1_P : access QtAda6.QtGui.QRegion.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMask");
      Args   := Tuple_New (1);
   ...
   procedure setMask (self : access Inst; arg_1_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMask");
      Args   := Tuple_New (1);
   ...
   procedure setMask (self : access Inst; arg_1_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setMask");
      Args   := Tuple_New (1);
   ...
   procedure setPalette (self : access Inst; arg_1_P : access QtAda6.QtGui.QPalette.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setPalette (self : access Inst; arg_1_P : access QtAda6.QtCore.Qt.GlobalColor.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setPalette");
      Args   := Tuple_New (1);
   ...
   procedure setPalette (self : access Inst; arg_1_P : access QtAda6.QtGui.QColor.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setPalette");
      Args   := Tuple_New (1);
   ...
   procedure setWindowIcon (self : access Inst; icon_P : access QtAda6.QtGui.QIcon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setWindowIcon (self : access Inst; icon_P : access QtAda6.QtGui.QPixmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setWindowIcon");
      Args   := Tuple_New (1);
   ...
   procedure update (self : access Inst; arg_1_P : access QtAda6.QtGui.QRegion.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "update");
      Args   := Tuple_New (1);
   ...
   procedure update (self : access Inst; arg_1_P : access QtAda6.QtGui.QBitmap.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "update");
      Args   := Tuple_New (1);
   ...
   procedure update (self : access Inst; arg_1_P : access QtAda6.QtGui.QPolygon.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "update");
      Args   := Tuple_New (1);
