...
package body QtAda6.QtWidgets.QCalendarWidget is
   ...
   function currentPageChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   function dateTextFormat (self : access Inst) return DICT_QtAda6_QtCore_QDateQtAda6_QtGui_QTextCharFormat is
      Method, Args, List, Result : Handle;
   begin
