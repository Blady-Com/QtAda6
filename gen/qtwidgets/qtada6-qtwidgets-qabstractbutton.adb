...
package body QtAda6.QtWidgets.QAbstractButton is
   ...
   procedure setShortcut (self : access Inst; key_P : access QtAda6.QtGui.QKeySequence.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setShortcut");
      Args   := Tuple_New (1);
   ...
   procedure setShortcut (self : access Inst; key_P : access QtAda6.QtCore.QKeyCombination.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setShortcut");
      Args   := Tuple_New (1);
   ...
   procedure setShortcut (self : access Inst; key_P : access QtAda6.QtGui.QKeySequence.StandardKey.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setShortcut");
      Args   := Tuple_New (1);
   ...
   procedure setShortcut (self : access Inst; key_P : str) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setShortcut");
      Args   := Tuple_New (1);
   ...
   procedure setShortcut (self : access Inst; key_P : int) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setShortcut");
      Args   := Tuple_New (1);
