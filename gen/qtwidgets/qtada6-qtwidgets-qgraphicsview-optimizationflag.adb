...
package body QtAda6.QtWidgets.QGraphicsView.OptimizationFlag is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DontSavePainterState"));
   end DontSavePainterState;
   function DontAdjustForAntialiasing return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DontAdjustForAntialiasing"));
   end DontAdjustForAntialiasing;
   function IndirectPainting return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IndirectPainting"));
