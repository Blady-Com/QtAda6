...
package body QtAda6.QtWidgets.QMainWindow.DockOption is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AnimatedDocks"));
   end AnimatedDocks;
   function AllowNestedDocks return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMainWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AllowNestedDocks"));
   end AllowNestedDocks;
   function AllowTabbedDocks return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMainWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AllowTabbedDocks"));
   end AllowTabbedDocks;
   function ForceTabbedDocks return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMainWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ForceTabbedDocks"));
   end ForceTabbedDocks;
   function VerticalTabs return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMainWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "VerticalTabs"));
   end VerticalTabs;
   function GroupedDragging return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMainWindow");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "GroupedDragging"));
   end GroupedDragging;
