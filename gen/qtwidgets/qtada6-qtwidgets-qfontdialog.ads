...
package QtAda6.QtWidgets.QFontDialog is
   ...
   procedure setCurrentFont (self : access Inst; font_P : access QtAda6.QtGui.QFont.Inst'Class);
   procedure setCurrentFont (self : access Inst; font_P : str);
   procedure setCurrentFont (self : access Inst; font_P : SEQUENCE_str);
   procedure setOption
