...
package QtAda6.QtWidgets.QFontDialog is
   ...
   function fontSelected (self : access Inst) return CLASSVAR_Signal;-- fontSelected(QFont)
   function Create
   ...
   procedure setCurrentFont (self : access Inst; font_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str);
   procedure setOption
