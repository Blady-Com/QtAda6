...
package QtAda6.QtWidgets.QApplication is
   ...
   procedure setFont (arg_1_P : access QtAda6.QtGui.QFont.Inst'Class; className_P : bytes := null);
   procedure setFont (arg_1_P : str; className_P : bytes := null);
   procedure setFont (arg_1_P : SEQUENCE_str; className_P : bytes := null);
   procedure setKeyboardInputInterval (arg_1_P : int);
   procedure setPalette (arg_1_P : access QtAda6.QtGui.QPalette.Inst'Class; className_P : bytes := null);
   procedure setPalette (arg_1_P : access QtAda6.QtCore.Qt.GlobalColor.Inst'Class; className_P : bytes := null);
   procedure setPalette (arg_1_P : access QtAda6.QtGui.QColor.Inst'Class; className_P : bytes := null);
