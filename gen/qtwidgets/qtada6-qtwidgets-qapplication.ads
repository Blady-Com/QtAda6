...
package QtAda6.QtWidgets.QApplication is
   ...
   function focusChanged (self : access Inst) return CLASSVAR_Signal;-- focusChanged(QWidget*,QWidget*)
   ...
   procedure setFont (arg_1_P : UNION_QtAda6_QtGui_QFontstrSEQUENCE_str; className_P : bytes := "");
