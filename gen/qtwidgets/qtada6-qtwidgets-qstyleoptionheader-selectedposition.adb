-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtwidgets-qstyleoptionheader-selectedposition.adb
...
package body QtAda6.QtWidgets.QStyleOptionHeader.SelectedPosition is
   use type QtAda6.int;
   ...
   function NextAndPreviousAreSelected return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QStyleOptionHeader");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NextAndPreviousAreSelected"));
   end NextAndPreviousAreSelected;
