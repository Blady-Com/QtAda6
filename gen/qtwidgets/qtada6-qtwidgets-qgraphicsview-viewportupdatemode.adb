...
package body QtAda6.QtWidgets.QGraphicsView.ViewportUpdateMode is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "ViewportUpdateMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "FullViewportUpdate"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ViewportUpdateMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "MinimalViewportUpdate"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ViewportUpdateMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "SmartViewportUpdate"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ViewportUpdateMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NoViewportUpdate"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsView");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ViewportUpdateMode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "BoundingRectViewportUpdate"));
