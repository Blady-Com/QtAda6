...
package body QtAda6.QtWidgets.QFileDialog.FileMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AnyFile"));
   end AnyFile;
   function ExistingFile return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QFileDialog");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ExistingFile"));
   end ExistingFile;
   function Directory return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QFileDialog");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Directory"));
   end Directory;
   function ExistingFiles return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QFileDialog");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ExistingFiles"));
   end ExistingFiles;
