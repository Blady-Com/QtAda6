...
package QtAda6.QtWidgets.QAbstractItemView is
   ...
   type Optional_QtAda6_QtCore_QEvent is access Any;
   ...
   activated       : ClassVar_Signal;-- activated(QModelIndex)
   clicked         : ClassVar_Signal;-- clicked(QModelIndex)
   doubleClicked   : ClassVar_Signal;-- doubleClicked(QModelIndex)
   entered         : ClassVar_Signal;-- entered(QModelIndex)
   iconSizeChanged : ClassVar_Signal;-- iconSizeChanged(QSize)
   pressed         : ClassVar_Signal;-- pressed(QModelIndex)
   viewportEntered : ClassVar_Signal;-- viewportEntered()
