...
package body QtAda6.QtWidgets.QComboBox is
   ...
   function editTextChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   function textActivated (self : access Inst) return CLASSVAR_Signal is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "textActivated"));
   end textActivated;
   function textHighlighted (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   procedure addItem
     (self : access Inst; icon_P : UNION_QtAda6_QtGui_QIconQtAda6_QtGui_QPixmap; text_P : str; userData_P : Any := null)
   is
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, (if userData_P /= null then userData_P.Python_Proxy else No_Value));
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if userData_P /= null then userData_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
   end addItem;
   ...
   begin
      ...
      Tuple_SetItem (Args, 3, (if userData_P /= null then userData_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
   end insertItem;
   ...
   procedure setItemIcon (self : access Inst; index_P : int; icon_P : UNION_QtAda6_QtGui_QIconQtAda6_QtGui_QPixmap) is
      Method, Args, List, Result : Handle;
   begin
