...
package body QtAda6.QtWidgets.QDataWidgetMapper.SubmitPolicy is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "SubmitPolicy");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "AutoSubmit"));
   end AutoSubmit;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QDataWidgetMapper");
      Enum_Class   := Object_GetAttrString (Parent_Class, "SubmitPolicy");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ManualSubmit"));
   end ManualSubmit;
