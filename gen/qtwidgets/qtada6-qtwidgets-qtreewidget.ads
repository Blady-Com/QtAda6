...
package QtAda6.QtWidgets.QTreeWidget is
   ...
   currentItemChanged   : ClassVar_Signal;-- currentItemChanged(QTreeWidgetItem*,QTreeWidgetItem*)
   itemActivated        : ClassVar_Signal;-- itemActivated(QTreeWidgetItem*,int)
   itemChanged          : ClassVar_Signal;-- itemChanged(QTreeWidgetItem*,int)
   itemClicked          : ClassVar_Signal;-- itemClicked(QTreeWidgetItem*,int)
   itemCollapsed        : ClassVar_Signal;-- itemCollapsed(QTreeWidgetItem*)
   itemDoubleClicked    : ClassVar_Signal;-- itemDoubleClicked(QTreeWidgetItem*,int)
   itemEntered          : ClassVar_Signal;-- itemEntered(QTreeWidgetItem*,int)
   itemExpanded         : ClassVar_Signal;-- itemExpanded(QTreeWidgetItem*)
   itemPressed          : ClassVar_Signal;-- itemPressed(QTreeWidgetItem*,int)
