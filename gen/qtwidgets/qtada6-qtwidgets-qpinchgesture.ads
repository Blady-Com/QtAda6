...
package QtAda6.QtWidgets.QPinchGesture is
   ...
   procedure setCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setCenterPoint (self : access Inst; value_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   procedure setChangeFlags (self : access Inst; value_P : access QtAda6.QtWidgets.QPinchGesture.ChangeFlag.Inst'Class);
   procedure setLastCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setLastCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setLastCenterPoint (self : access Inst; value_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
   ...
   procedure setStartCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setStartCenterPoint (self : access Inst; value_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setStartCenterPoint (self : access Inst; value_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class);
