...
package body QtAda6.QtWidgets.QCompleter.ModelSorting is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UnsortedModel"));
   end UnsortedModel;
   function CaseSensitivelySortedModel return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QCompleter");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CaseSensitivelySortedModel"));
   end CaseSensitivelySortedModel;
   function CaseInsensitivelySortedModel return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QCompleter");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CaseInsensitivelySortedModel"));
