...
package QtAda6.QtWidgets.QStyleOptionToolBox.SelectedPosition is
   ...
   NotAdjacent        : QStyleOptionToolBox.SelectedPosition.Class;-- 0x0
   NextIsSelected     : QStyleOptionToolBox.SelectedPosition.Class;-- 0x1
   PreviousIsSelected : QStyleOptionToolBox.SelectedPosition.Class;-- 0x2
