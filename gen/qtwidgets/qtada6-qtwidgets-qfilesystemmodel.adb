...
package body QtAda6.QtWidgets.QFileSystemModel is
   ...
   function directoryLoaded (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "directoryLoaded"));
   end directoryLoaded;
   function fileRenamed (self : access Inst) return CLASSVAR_Signal is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "fileRenamed"));
   end fileRenamed;
   function rootPathChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
