...
package body QtAda6.QtWidgets.QAbstractSpinBox.StepType is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DefaultStepType"));
   end DefaultStepType;
   function AdaptiveDecimalStepType return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QAbstractSpinBox");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AdaptiveDecimalStepType"));
