-------------------------------------------------------------------------------
-- NAME (body)                  : qtada6-qtwidgets-qmessagebox-icon.adb
...
package body QtAda6.QtWidgets.QMessageBox.Icon is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "Icon");
   ...
   function Question return Class is
      Parent_Class, Enum_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QMessageBox");
      Enum_Class   := Object_GetAttrString (Parent_Class, "Icon");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Question"));
   end Question;
