...
package body QtAda6.QtWidgets.QGraphicsBlurEffect.BlurHint is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "PerformanceHint"));
   end PerformanceHint;
   function QualityHint return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsBlurEffect");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "QualityHint"));
   end QualityHint;
   function AnimationHint return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtWidgets_Python_Proxy, "QGraphicsBlurEffect");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AnimationHint"));
   end AnimationHint;
