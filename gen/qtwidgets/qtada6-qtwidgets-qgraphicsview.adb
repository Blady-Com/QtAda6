...
package body QtAda6.QtWidgets.QGraphicsView is
   ...
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtCore.QPointF.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "centerOn");
      Args   := Tuple_New (1);
   ...
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtCore.QPoint.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "centerOn");
      Args   := Tuple_New (1);
   ...
   procedure centerOn (self : access Inst; pos_P : access QtAda6.QtGui.QPainterPath.Element.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "centerOn");
      Args   := Tuple_New (1);
   ...
   procedure ensureVisible
     (self : access Inst; rect_P : access QtAda6.QtCore.QRectF.Inst'Class; xmargin_P : int := 0; ymargin_P : int := 0)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "ensureVisible");
   ...
   procedure ensureVisible
     (self : access Inst; rect_P : access QtAda6.QtCore.QRect.Inst'Class; xmargin_P : int := 0; ymargin_P : int := 0)
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "ensureVisible");
   ...
   function mapFromScene
     (self : access Inst; polygon_P : SEQUENCE_QtAda6_QtCore_QRectF) return access QtAda6.QtGui.QPolygon.Inst'Class
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
      Ret : constant QtAda6.QtGui.QPolygon.Class := new QtAda6.QtGui.QPolygon.Inst;
   begin
   ...
   function mapFromScene
     (self : access Inst; rect_P : access QtAda6.QtCore.QRect.Inst'Class) return access QtAda6.QtGui.QPolygon.Inst'Class
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
      Ret : constant QtAda6.QtGui.QPolygon.Class := new QtAda6.QtGui.QPolygon.Inst;
   begin
   ...
   function mapToScene
     (self : access Inst; polygon_P : SEQUENCE_QtAda6_QtCore_QRect) return access QtAda6.QtGui.QPolygonF.Inst'Class
   is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
      Ret : constant QtAda6.QtGui.QPolygonF.Class := new QtAda6.QtGui.QPolygonF.Inst;
   begin
   ...
   procedure updateSceneRect (self : access Inst; rect_P : access QtAda6.QtCore.QRectF.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure updateSceneRect (self : access Inst; rect_P : access QtAda6.QtCore.QRect.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "updateSceneRect");
      Args   := Tuple_New (1);
