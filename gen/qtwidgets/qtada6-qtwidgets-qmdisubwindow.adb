...
package body QtAda6.QtWidgets.QMdiSubWindow is
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, changeEvent_P.Python_Proxy);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, childEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end childEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, closeEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end closeEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, contextMenuEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, focusInEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end focusInEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, focusOutEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end focusOutEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, keyEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end keyPressEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, leaveEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end leaveEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, paintEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end paintEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, resizeEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end resizeEvent;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, systemMenu_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setSystemMenu;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, timerEvent_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end timerEvent;
