...
package body QtAda6.QtWidgets.QScroller is
   ...
   function scrollerPropertiesChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if gestureType_P /= null then gestureType_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end grabGesture;
