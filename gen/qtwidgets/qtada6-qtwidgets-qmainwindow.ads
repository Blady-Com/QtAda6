...
package QtAda6.QtWidgets.QMainWindow is
   ...
   type Sequence_QtAda6_QtWidgets_QDockWidget is access Any;
   type Sequence_int is access Any;
   type Union_QtAda6_QtCore_QByteArray_bytes is access Any;
   type List_QtAda6_QtWidgets_QDockWidget is access Any;
   type Inst;
   ...
   tabifiedDockWidgetActivated : ClassVar_Signal;-- tabifiedDockWidgetActivated(QDockWidget*)
   ...
   procedure addToolBarBreak (self : access Inst; area_P : access QtAda6.QtCore.Qt.ToolBarArea.Inst'Class);
   ...
   function saveState (self : access Inst; version_P : int) return access QtAda6.QtCore.QByteArray.Inst'Class;
