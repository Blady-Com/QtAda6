...
package QtAda6.QtWidgets.QFileSystemModel is
   ...
   function directoryLoaded (self : access Inst) return CLASSVAR_Signal;-- directoryLoaded(QString)
   function fileRenamed (self : access Inst) return CLASSVAR_Signal;-- fileRenamed(QString,QString,QString)
   function rootPathChanged (self : access Inst) return CLASSVAR_Signal;-- rootPathChanged(QString)
   ...
   function mkdir
     (self : access Inst; parent_P : UNION_QtAda6_QtCore_QModelIndexQtAda6_QtCore_QPersistentModelIndex; name_P : str)
      return access QtAda6.QtCore.QModelIndex.Inst'Class;
