...
package QtAda6.QtWidgets.QFileSystemModel is
   ...
   function fileInfo
     (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class)
      return access QtAda6.QtCore.QFileInfo.Inst'Class;
   function fileName (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return str;
   function fileName (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return str;
   function filePath (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return str;
   function filePath (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return str;
   ...
   function index
     (self     : access Inst; row_P : int; column_P : int;
      ...
      return access QtAda6.QtCore.QModelIndex.Inst'Class;
   function isDir (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return bool;
   function isDir (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return bool;
   ...
   function parent
     (self : access Inst; child_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class)
      return access QtAda6.QtCore.QModelIndex.Inst'Class;
   function remove (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return bool;
   function remove (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return bool;
   function resolveSymlinks (self : access Inst) return bool;
   function rmdir (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return bool;
   function rmdir (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return bool;
   ...
   function sibling
     (self : access Inst; row_P : int; column_P : int; idx_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class)
      return access QtAda6.QtCore.QModelIndex.Inst'Class;
   function size (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return int;
   function size (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return int;
   ...
   function type_K (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return str;
   function type_K (self : access Inst; index_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class) return str;
