...
package body QtAda6.QtCore.QDir is
   ...
   function Create (arg_1_P : UNION_QtAda6_QtCore_QDirstr) return Class is
   ...
   function Create (path_P : UNION_strbytesos_PathLikeNoneType) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QDir");
      Args  := Tuple_New (1);
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, (if sort_P /= null then sort_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 3, (if filter_P /= null then filter_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   procedure addSearchPath (prefix_P : str; path_P : UNION_strbytesos_PathLike) is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QDir");
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if sort_P /= null then sort_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
      return (2 .. 1 => <>);
   end entryInfoList;
   function entryInfoList
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if filters_P /= null then filters_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 2, (if sort_P /= null then sort_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
      return (2 .. 1 => <>);
   end entryInfoList;
   ...
   procedure setPath (self : access Inst; path_P : UNION_strbytesos_PathLike) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtCore_QDirstr) is
      Method, Args, List, Result : Handle;
   begin
