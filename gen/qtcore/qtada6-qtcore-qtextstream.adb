...
package body QtAda6.QtCore.QTextStream is
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, openMode_P.Python_Proxy);
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   function readLine (self : access Inst; maxlen_P : int) return str is
      Method, Args, Result : Handle;
   begin
   ...
   function readLineInto (self : access Inst; maxlen_P : int) return Tuple_bool_str is
      Method, Args, Result : Handle;
   begin
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, notation_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, status_P.Python_Proxy);
      Result := Object_CallObject (Method, Args, True);
   end setStatus;
