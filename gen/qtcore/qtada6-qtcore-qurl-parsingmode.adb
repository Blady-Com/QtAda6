...
package body QtAda6.QtCore.QUrl.ParsingMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "TolerantMode"));
   end TolerantMode;
   function StrictMode return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUrl");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "StrictMode"));
   end StrictMode;
   function DecodedMode return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUrl");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DecodedMode"));
   end DecodedMode;
