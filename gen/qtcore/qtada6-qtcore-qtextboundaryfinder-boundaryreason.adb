...
package body QtAda6.QtCore.QTextBoundaryFinder.BoundaryReason is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NotAtBoundary"));
   end NotAtBoundary;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "BreakOpportunity"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "StartOfItem"));
   end StartOfItem;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "EndOfItem"));
   end EndOfItem;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "MandatoryBreak"));
   end MandatoryBreak;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryReason");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "SoftHyphen"));
   end SoftHyphen;
