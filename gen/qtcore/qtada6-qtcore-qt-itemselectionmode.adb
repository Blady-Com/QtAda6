...
package body QtAda6.QtCore.Qt.ItemSelectionMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ContainsItemShape"));
   end ContainsItemShape;
   function IntersectsItemShape return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IntersectsItemShape"));
   end IntersectsItemShape;
   function ContainsItemBoundingRect return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ContainsItemBoundingRect"));
   end ContainsItemBoundingRect;
   function IntersectsItemBoundingRect return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IntersectsItemBoundingRect"));
