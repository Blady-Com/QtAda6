...
package QtAda6.QtCore.QCollator is
   ...
   function Create (locale_P : access QtAda6.QtCore.QLocale.Inst'Class) return Class;
   function Create (locale_P : access QtAda6.QtCore.QLocale.Language.Inst'Class) return Class;
