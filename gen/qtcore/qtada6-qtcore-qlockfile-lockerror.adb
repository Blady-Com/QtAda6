...
package body QtAda6.QtCore.QLockFile.LockError is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "LockError");
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLockFile");
      Enum_Class   := Object_GetAttrString (Parent_Class, "LockError");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "LockFailedError"));
   end LockFailedError;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLockFile");
      Enum_Class   := Object_GetAttrString (Parent_Class, "LockError");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "PermissionError"));
   end PermissionError;
