...
package body QtAda6.QtCore.QResource is
   ...
   function Create (file_P : str; locale_P : Union_QtAda6_QtCore_QLocale_QtAda6_QtCore_QLocale_Language) return Class is
      Class, Args : Handle;
   begin
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, Unicode_FromString (resourceRoot_P));
      Result := Object_CallObject (Method, Args, True);
      return To_Ada (Result);
