...
package QtAda6.QtCore.QEasingCurve is
   ...
   function Create (other_P : UNION_QtAda6_QtCore_QEasingCurveQtAda6_QtCore_QEasingCurve_Type_K) return Class;
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtCore_QEasingCurveQtAda6_QtCore_QEasingCurve_Type_K);
