...
package QtAda6.QtCore.QTime is
   ...
   function Create (h_P : int; m_P : int; s_P : int; ms_P : int) return Class;
   procedure U_copy_U;
   ...
   function isValid (h_P : int; m_P : int; s_P : int; ms_P : int) return bool;
   ...
   function setHMS (self : access Inst; h_P : int; m_P : int; s_P : int; ms_P : int) return bool;
   function toPython (self : access Inst) return Object;
   function toString (self : access Inst; f_P : access QtAda6.QtCore.Qt.DateFormat.Inst'Class) return str;
