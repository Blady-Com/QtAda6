...
package body QtAda6.QtCore.QLocale.NumberOption is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "DefaultNumberOptions"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "OmitGroupSeparator"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "RejectGroupSeparator"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "OmitLeadingZeroInExponent"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "RejectLeadingZeroInExponent"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "IncludeTrailingZeroesAfterDot"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "NumberOption");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "RejectTrailingZeroesAfterDot"));
