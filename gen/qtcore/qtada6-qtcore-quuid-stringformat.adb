...
package body QtAda6.QtCore.QUuid.StringFormat is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "StringFormat");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "WithBraces"));
   end WithBraces;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUuid");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StringFormat");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "WithoutBraces"));
   end WithoutBraces;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUuid");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StringFormat");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Id128"));
   end Id128;
