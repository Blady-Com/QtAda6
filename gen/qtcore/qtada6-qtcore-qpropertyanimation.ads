...
package QtAda6.QtCore.QPropertyAnimation is
   ...
   procedure setPropertyName (self : access Inst; propertyName_P : access QtAda6.QtCore.QByteArray.Inst'Class);
   procedure setPropertyName (self : access Inst; propertyName_P : bytes);
