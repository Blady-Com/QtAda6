...
package body QtAda6.QtCore.QPointF is
   ...
   function Create (QPointF_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QPointF");
      Args  := Tuple_New (1);
      Tuple_SetItem (Args, 0, (if QPointF_P /= null then QPointF_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   function U_add_U
     (self : access Inst; p2_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint)
   ...
   function dotProduct
     (p1_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint; p2_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint)
      return float
   is
      Class, Method, Args, List, Result : Handle;
   begin
