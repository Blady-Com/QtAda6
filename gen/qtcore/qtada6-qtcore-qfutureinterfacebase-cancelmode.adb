...
package body QtAda6.QtCore.QFutureInterfaceBase.CancelMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CancelOnly"));
   end CancelOnly;
   function CancelAndFinish return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QFutureInterfaceBase");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "CancelAndFinish"));
   end CancelAndFinish;
