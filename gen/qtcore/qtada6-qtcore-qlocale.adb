...
package body QtAda6.QtCore.QLocale is
   ...
   begin
      ...
      Dict := Dict_New;
      if script_P /= null then
         Dict_SetItemString (Dict, "script", script_P.Python_Proxy);
      end if;
   ...
   function Create (other_P : access QtAda6.QtCore.QLocale.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Args  := Tuple_New (1);
   ...
   function Create (other_P : access QtAda6.QtCore.QLocale.Language.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Args  := Tuple_New (1);
   ...
   function c return access QtAda6.QtCore.QLocale.Inst'Class is
      Class, Method, Args, Dict, List, Tuple, Set, Result : Handle;
   ...
   begin
      ...
      Dict := Dict_New;
      if codeTypes_P /= null then
         Dict_SetItemString (Dict, "codeTypes", codeTypes_P.Python_Proxy);
      end if;
      Result           := Object_Call (Method, Args, Dict, True);
      Ret.Python_Proxy := Result;
      return Ret;
   ...
   begin
      ...
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Ret : LIST_QtAda6_QtCore_QLocale_Country (1 .. Natural (List_Size (Result))) do
   ...
   begin
      ...
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Ret : LIST_QtAda6_QtCore_QLocale (1 .. Natural (List_Size (Result))) do
         for Ind in Ret'Range loop
            Ret (Ind).Python_Proxy := List_GetItem (Result, ssize_t (Ind - Ret'First));
         end loop;
      end return;
   ...
   procedure setDefault (locale_P : access QtAda6.QtCore.QLocale.Inst'Class) is
      Class, Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
   ...
   procedure setDefault (locale_P : access QtAda6.QtCore.QLocale.Language.Inst'Class) is
      Class, Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Method := Object_GetAttrString (Class, "setDefault");
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtCore.QLocale.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtCore.QLocale.Language.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "swap");
      Args   := Tuple_New (1);
   ...
   function system return access QtAda6.QtCore.QLocale.Inst'Class is
      Class, Method, Args, Dict, List, Tuple, Set, Result : Handle;
      Ret : constant QtAda6.QtCore.QLocale.Class := new QtAda6.QtCore.QLocale.Inst;
   begin
      Class            := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
   ...
   begin
      ...
      Dict := Dict_New;
      if symbol_P /= "" then
         Dict_SetItemString (Dict, "symbol", Unicode_FromString (symbol_P));
      end if;
      if precision_P /= 0 then
         Dict_SetItemString (Dict, "precision", Long_FromLong (precision_P));
      end if;
   ...
   function toDouble (self : access Inst; s_P : str) return TUPLE_float_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toDouble");
      Args   := Tuple_New (1);
   ...
   function toFloat (self : access Inst; s_P : str) return TUPLE_float_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toFloat");
      Args   := Tuple_New (1);
   ...
   function toInt (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toInt");
      Args   := Tuple_New (1);
   ...
   function toLongLong (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toLongLong");
      Args   := Tuple_New (1);
   ...
   function toShort (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toShort");
      Args   := Tuple_New (1);
   ...
   function toUInt (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toUInt");
      Args   := Tuple_New (1);
   ...
   function toULongLong (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toULongLong");
      Args   := Tuple_New (1);
   ...
   function toUShort (self : access Inst; s_P : str) return TUPLE_int_bool is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "toUShort");
      Args   := Tuple_New (1);
   ...
   begin
      ...
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Ret : LIST_QtAda6_QtCore_Qt_DayOfWeek (1 .. Natural (List_Size (Result))) do
         for Ind in Ret'Range loop
            Ret (Ind).Python_Proxy := List_GetItem (Result, ssize_t (Ind - Ret'First));
         end loop;
      end return;
