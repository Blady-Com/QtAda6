...
package QtAda6.QtCore.QFileInfo is
   ...
   function Create (dir_P : access QtAda6.QtCore.QDir.Inst'Class; file_P : str) return Class;
   function Create (dir_P : access QtAda6.QtCore.QDir.Inst'Class; file_P : bytes) return Class;
   function Create (dir_P : access QtAda6.QtCore.QDir.Inst'Class; file_P : OS.PathLike) return Class;
   function Create (dir_P : str; file_P : str) return Class;
   function Create (dir_P : str; file_P : bytes) return Class;
   function Create (dir_P : str; file_P : OS.PathLike) return Class;
   function Create (file_P : str) return Class;
   function Create (file_P : bytes) return Class;
   function Create (file_P : OS.PathLike) return Class;
   ...
   procedure setFile (self : access Inst; dir_P : access QtAda6.QtCore.QDir.Inst'Class; file_P : str);
   procedure setFile (self : access Inst; dir_P : str; file_P : str);
   procedure setFile (self : access Inst; file_P : str);
   procedure setFile (self : access Inst; file_P : bytes);
   procedure setFile (self : access Inst; file_P : OS.PathLike);
