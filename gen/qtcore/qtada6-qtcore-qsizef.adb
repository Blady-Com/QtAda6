...
package body QtAda6.QtCore.QSizeF is
   ...
   function Create (QSizeF_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QSizeF");
      Args  := Tuple_New (1);
   ...
   function U_add_U
     (self : access Inst; s2_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize)
   ...
   function U_iadd_U
     (self : access Inst; arg_1_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize)
      return access QtAda6.QtCore.QSizeF.Inst'Class
   is
      Method, Args, List, Result : Handle;
      Ret                        : constant QtAda6.QtCore.QSizeF.Class := new QtAda6.QtCore.QSizeF.Inst;
   ...
   function grownBy
     (self : access Inst; m_P : UNION_QtAda6_QtCore_QMarginsFQtAda6_QtCore_QMargins)
      return access QtAda6.QtCore.QSizeF.Inst'Class
   is
      Method, Args, List, Result : Handle;
      Ret                        : constant QtAda6.QtCore.QSizeF.Class := new QtAda6.QtCore.QSizeF.Inst;
   ...
   procedure scale
     (self   : access Inst; s_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize;
