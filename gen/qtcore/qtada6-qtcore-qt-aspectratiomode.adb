...
package body QtAda6.QtCore.Qt.AspectRatioMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IgnoreAspectRatio"));
   end IgnoreAspectRatio;
   function KeepAspectRatio return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "KeepAspectRatio"));
   end KeepAspectRatio;
   function KeepAspectRatioByExpanding return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "KeepAspectRatioByExpanding"));
