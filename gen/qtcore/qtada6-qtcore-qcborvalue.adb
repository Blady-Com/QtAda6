...
package body QtAda6.QtCore.QCborValue is
   ...
   function Create (ba_P : UNION_QtAda6_QtCore_QByteArraybytes) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      Args  := Tuple_New (1);
   ...
   function Create (rx_P : UNION_QtAda6_QtCore_QRegularExpressionstr) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      Args  := Tuple_New (1);
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if tv_P /= null then tv_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, (if taggedValue_P /= null then taggedValue_P.Python_Proxy else No_Value));
      return new Inst'(Python_Proxy => Object_CallObject (Class, Args, True));
   end Create;
   function Create (url_P : UNION_QtAda6_QtCore_QUrlstr) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      Args  := Tuple_New (1);
   ...
   begin
      ...
      Tuple_SetItem (Args, 2, (if error_P /= null then error_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end fromCbor;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, (if opt_P /= null then opt_P.Python_Proxy else No_Value));
      Result           := Object_CallObject (Method, Args, True);
      Ret.Python_Proxy := Result;
      return Ret;
   end toCbor;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, (if opts_P /= null then opts_P.Python_Proxy else No_Value));
      Result := Object_CallObject (Method, Args, True);
