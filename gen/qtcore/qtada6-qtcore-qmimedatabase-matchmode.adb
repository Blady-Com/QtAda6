...
package body QtAda6.QtCore.QMimeDatabase.MatchMode is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "MatchDefault"));
   end MatchDefault;
   function MatchExtension return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMimeDatabase");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "MatchExtension"));
   end MatchExtension;
   function MatchContent return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMimeDatabase");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "MatchContent"));
   end MatchContent;
