...
package body QtAda6.QtCore.QLineF is
   ...
   function Create (QLineF_P : UNION_QtAda6_QtCore_QLineFQtAda6_QtCore_QLine) return Class is
      Class, Args, List : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLineF");
      Args  := Tuple_New (1);
   ...
   function angleTo (self : access Inst; l_P : UNION_QtAda6_QtCore_QLineFQtAda6_QtCore_QLine) return float is
      Method, Args, List, Result : Handle;
   begin
   ...
   function intersects (self : access Inst; l_P : UNION_QtAda6_QtCore_QLineFQtAda6_QtCore_QLine) return TUPLE is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure setP1 (self : access Inst; p1_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure setP2 (self : access Inst; p2_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint) is
      Method, Args, List, Result : Handle;
   begin
