...
package body QtAda6.QtCore.QStandardPaths.LocateOption is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "LocateFile"));
   end LocateFile;
   function LocateDirectory return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QStandardPaths");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "LocateDirectory"));
   end LocateDirectory;
