...
package QtAda6.QtCore.QFileSystemWatcher is
   ...
   function directoryChanged (self : access Inst) return CLASSVAR_Signal;-- directoryChanged(QString)
   function fileChanged (self : access Inst) return CLASSVAR_Signal;-- fileChanged(QString)
