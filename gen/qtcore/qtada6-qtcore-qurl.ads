...
package QtAda6.QtCore.QUrl is
   ...
   function Create (copy_P : UNION_QtAda6_QtCore_QUrlstr) return Class;
   ...
   function fromEncoded
     (url_P : UNION_QtAda6_QtCore_QByteArraybytes; mode_P : access QtAda6.QtCore.QUrl.ParsingMode.Inst'Class := null)
      return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromLocalFile (localfile_P : UNION_strbytesos_PathLike) return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromPercentEncoding (arg_1_P : UNION_QtAda6_QtCore_QByteArraybytes) return str;
   ...
   function isParentOf (self : access Inst; url_P : UNION_QtAda6_QtCore_QUrlstr) return bool;
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtCore_QUrlstr);
   function toAce
