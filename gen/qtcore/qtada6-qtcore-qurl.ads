...
package QtAda6.QtCore.QUrl is
   ...
   function Create (copy_P : access QtAda6.QtCore.QUrl.Inst'Class) return Class;
   function Create (copy_P : str) return Class;
   ...
   function fromEncoded
     (url_P : bytes; mode_P : access QtAda6.QtCore.QUrl.ParsingMode.Inst'Class := null)
      return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromLocalFile (localfile_P : str) return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromLocalFile (localfile_P : bytes) return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromLocalFile (localfile_P : OS.PathLike) return access QtAda6.QtCore.QUrl.Inst'Class;
   function fromPercentEncoding (arg_1_P : access QtAda6.QtCore.QByteArray.Inst'Class) return str;
   function fromPercentEncoding (arg_1_P : bytes) return str;
   ...
   function isParentOf (self : access Inst; url_P : access QtAda6.QtCore.QUrl.Inst'Class) return bool;
   function isParentOf (self : access Inst; url_P : str) return bool;
   ...
   function query
     (self : access Inst; arg_1_P : access QtAda6.QtCore.QUrl.ComponentFormattingOption.Inst'Class := null) return str;
   function resolved
     (self : access Inst; relative_P : access QtAda6.QtCore.QUrl.Inst'Class)
      return access QtAda6.QtCore.QUrl.Inst'Class;
   function resolved (self : access Inst; relative_P : str) return access QtAda6.QtCore.QUrl.Inst'Class;
   ...
   procedure swap (self : access Inst; other_P : access QtAda6.QtCore.QUrl.Inst'Class);
