...
package body QtAda6.QtCore.QTimeZone.TimeType is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "TimeType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "StandardTime"));
   end StandardTime;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTimeZone");
      Enum_Class   := Object_GetAttrString (Parent_Class, "TimeType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "DaylightTime"));
   end DaylightTime;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTimeZone");
      Enum_Class   := Object_GetAttrString (Parent_Class, "TimeType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "GenericTime"));
   end GenericTime;
