...
package QtAda6.QtCore.QTimeZone is
   ...
   function Create (ianaId_P : UNION_QtAda6_QtCore_QByteArraybytes) return Class;
   ...
   function isTimeZoneIdAvailable (ianaId_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool;
