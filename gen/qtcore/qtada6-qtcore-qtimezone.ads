...
package QtAda6.QtCore.QTimeZone is
   ...
   function Create (ianaId_P : access QtAda6.QtCore.QByteArray.Inst'Class) return Class;
   function Create (ianaId_P : bytes) return Class;
   ...
   function ianaIdToWindowsId (ianaId_P : bytes) return access QtAda6.QtCore.QByteArray.Inst'Class;
   ...
   function isTimeZoneIdAvailable (ianaId_P : access QtAda6.QtCore.QByteArray.Inst'Class) return bool;
   function isTimeZoneIdAvailable (ianaId_P : bytes) return bool;
   ...
   function windowsIdToDefaultIanaId (windowsId_P : bytes) return access QtAda6.QtCore.QByteArray.Inst'Class;
   function windowsIdToDefaultIanaId
   ...
   function windowsIdToIanaIds (windowsId_P : bytes) return LIST_QtAda6_QtCore_QByteArray;
   function windowsIdToIanaIds
     (windowsId_P : access QtAda6.QtCore.QByteArray.Inst'Class;
      territory_P : access QtAda6.QtCore.QLocale.Country.Inst'Class) return LIST_QtAda6_QtCore_QByteArray;
   function windowsIdToIanaIds
