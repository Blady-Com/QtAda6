...
package QtAda6.QtCore.QMimeDatabase is
   ...
   function mimeTypeForData (self : access Inst; data_P : bytes) return access QtAda6.QtCore.QMimeType.Inst'Class;
   function mimeTypeForData
   ...
   function mimeTypeForUrl
     (self : access Inst; url_P : access QtAda6.QtCore.QUrl.Inst'Class)
      return access QtAda6.QtCore.QMimeType.Inst'Class;
   function mimeTypeForUrl (self : access Inst; url_P : str) return access QtAda6.QtCore.QMimeType.Inst'Class;
