...
package body QtAda6.QtCore.Qt.ToolButtonStyle is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "ToolButtonStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ToolButtonIconOnly"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ToolButtonStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ToolButtonTextOnly"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ToolButtonStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ToolButtonTextBesideIcon"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ToolButtonStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ToolButtonTextUnderIcon"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      Enum_Class   := Object_GetAttrString (Parent_Class, "ToolButtonStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ToolButtonFollowStyle"));
