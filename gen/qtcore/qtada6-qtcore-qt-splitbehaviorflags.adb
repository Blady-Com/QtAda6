...
package body QtAda6.QtCore.Qt.SplitBehaviorFlags is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "KeepEmptyParts"));
   end KeepEmptyParts;
   function SkipEmptyParts return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "SkipEmptyParts"));
   end SkipEmptyParts;
