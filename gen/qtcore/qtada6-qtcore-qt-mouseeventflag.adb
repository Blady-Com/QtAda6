...
package body QtAda6.QtCore.Qt.MouseEventFlag is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NoMouseEventFlag"));
   end NoMouseEventFlag;
   function MouseEventCreatedDoubleClick return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "MouseEventCreatedDoubleClick"));
   end MouseEventCreatedDoubleClick;
   function MouseEventFlagMask return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "MouseEventFlagMask"));
