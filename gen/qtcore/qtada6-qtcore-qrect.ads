...
package QtAda6.QtCore.QRect is
   ...
   function contains (self : access Inst; p_P : access QtAda6.QtCore.QPoint.Inst'Class; proper_P : bool) return bool;
   function contains (self : access Inst; r_P : access QtAda6.QtCore.QRect.Inst'Class; proper_P : bool) return bool;
   ...
   function getCoords (self : access Inst) return Object;
   function getRect (self : access Inst) return Object;
