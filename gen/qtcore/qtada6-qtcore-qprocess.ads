...
package QtAda6.QtCore.QProcess is
   ...
   function errorOccurred
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- errorOccurred(QProcess::ProcessError)
   function finished
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- finished(int,QProcess::ExitStatus)
   function readyReadStandardError
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- readyReadStandardError()
   function readyReadStandardOutput
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- readyReadStandardOutput()
   function started (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- started()
   function stateChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- stateChanged(QProcess::ProcessState)
