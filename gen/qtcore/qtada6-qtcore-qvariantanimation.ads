...
package QtAda6.QtCore.QVariantAnimation is
   ...
   type TUPLE_float_Any is record
      C0 : float;
      C1 : Any;
   end record;
   type LIST_TUPLE_float_Any is array (Positive range <>) of TUPLE_float_Any;
   type SEQUENCE_TUPLE_float_Any is array (Positive range <>) of TUPLE_float_Any;
   procedure Finalize (Self : in out Class);
   function valueChanged (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- valueChanged(QVariant)
   ...
   procedure setEasingCurve (self : access Inst; easing_P : access QtAda6.QtCore.QEasingCurve.Inst'Class);
   procedure setEasingCurve (self : access Inst; easing_P : access QtAda6.QtCore.QEasingCurve.Type_K.Inst'Class);
