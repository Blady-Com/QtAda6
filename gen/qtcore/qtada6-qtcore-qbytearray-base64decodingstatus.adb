...
package body QtAda6.QtCore.QByteArray.Base64DecodingStatus is
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QByteArray");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IllegalInputLength"));
   end IllegalInputLength;
   function IllegalCharacter return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QByteArray");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IllegalCharacter"));
   end IllegalCharacter;
   function IllegalPadding return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QByteArray");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "IllegalPadding"));
   end IllegalPadding;
