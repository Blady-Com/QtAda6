...
package body QtAda6.QtCore.Qt.DockWidgetArea is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NoDockWidgetArea"));
   end NoDockWidgetArea;
   function LeftDockWidgetArea return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "LeftDockWidgetArea"));
   end LeftDockWidgetArea;
   function RightDockWidgetArea return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "RightDockWidgetArea"));
   end RightDockWidgetArea;
   function TopDockWidgetArea return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "TopDockWidgetArea"));
   end TopDockWidgetArea;
   function BottomDockWidgetArea return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "BottomDockWidgetArea"));
   end BottomDockWidgetArea;
   function AllDockWidgetAreas return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "AllDockWidgetAreas"));
   end AllDockWidgetAreas;
   function DockWidgetArea_Mask return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "DockWidgetArea_Mask"));
