...
package body QtAda6.QtCore.QSocketNotifier.Type_K is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Read"));
   end Read;
   function Write return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QSocketNotifier");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Write"));
   end Write;
   function Exception_K return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QSocketNotifier");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Exception"));
   end Exception_K;
