...
package body QtAda6.QtCore.QLibrary is
   ...
   begin
      ...
      Args   := Tuple_New (2);
      Tuple_SetItem (Args, 0, Unicode_FromString (fileName_P));
      Tuple_SetItem (Args, 1, Bytes_FromString (Standard.String (symbol_P.all)));
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
   ...
   begin
      ...
      Tuple_SetItem (Args, 0, Unicode_FromString (fileName_P));
      Tuple_SetItem (Args, 1, Long_FromLong (verNum_P));
      Tuple_SetItem (Args, 2, Bytes_FromString (Standard.String (symbol_P.all)));
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Long_AsLong (Result);
   end resolve;
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, Bytes_FromString (Standard.String (symbol_P.all)));
      Dict   := Dict_New;
      Result := Object_Call (Method, Args, Dict, True);
      return Long_AsLong (Result);
   end resolve;
