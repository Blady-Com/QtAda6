...
package QtAda6.QtCore.SignalInstance is
   ...
   procedure connect (self : access Inst; slot_P : access Object'Class; type_K_P : Type_K_T := null);
   procedure disconnect (self : access Inst; slot_P : access Object'Class := null);
