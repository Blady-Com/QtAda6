...
package body QtAda6.QtCore.QMarginsF is
   ...
   function Create (QMarginsF_P : access QtAda6.QtCore.QMarginsF.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMarginsF");
      Args  := Tuple_New (1);
   ...
   function Create (QMarginsF_P : access QtAda6.QtCore.QMargins.Inst'Class) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMarginsF");
      Args  := Tuple_New (1);
