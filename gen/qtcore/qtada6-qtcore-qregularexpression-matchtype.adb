...
package body QtAda6.QtCore.QRegularExpression.MatchType is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "MatchType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NormalMatch"));
   end NormalMatch;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QRegularExpression");
      Enum_Class   := Object_GetAttrString (Parent_Class, "MatchType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "PartialPreferCompleteMatch"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QRegularExpression");
      Enum_Class   := Object_GetAttrString (Parent_Class, "MatchType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "PartialPreferFirstMatch"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QRegularExpression");
      Enum_Class   := Object_GetAttrString (Parent_Class, "MatchType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NoMatch"));
   end NoMatch;
