...
package QtAda6.QtCore.QLineF is
   ...
   function Create (QLineF_P : UNION_QtAda6_QtCore_QLineF_QtAda6_QtCore_QLine) return Class;
   ...
   function angleTo (self : access Inst; l_P : UNION_QtAda6_QtCore_QLineF_QtAda6_QtCore_QLine) return float;
   ...
   function intersects (self : access Inst; l_P : UNION_QtAda6_QtCore_QLineF_QtAda6_QtCore_QLine) return TUPLE;
   ...
   procedure setP1 (self : access Inst; p1_P : UNION_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint);
   procedure setP2 (self : access Inst; p2_P : UNION_QtAda6_QtCore_QPointF_QtAda6_QtCore_QPoint);
   procedure setPoints
