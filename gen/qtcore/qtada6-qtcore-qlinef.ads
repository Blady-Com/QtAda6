...
package QtAda6.QtCore.QLineF is
   ...
   function Create (QLineF_P : access QtAda6.QtCore.QLineF.Inst'Class) return Class;
   function Create (QLineF_P : access QtAda6.QtCore.QLine.Inst'Class) return Class;
-- function Create(line_P : access QtAda6.QtCore.QLine.Inst'Class) return Class;
   ...
   function angleTo (self : access Inst; l_P : access QtAda6.QtCore.QLineF.Inst'Class) return float;
   function angleTo (self : access Inst; l_P : access QtAda6.QtCore.QLine.Inst'Class) return float;
   ...
   function intersects (self : access Inst; l_P : access QtAda6.QtCore.QLineF.Inst'Class) return TUPLE;
   function intersects (self : access Inst; l_P : access QtAda6.QtCore.QLine.Inst'Class) return TUPLE;
   ...
   procedure setP1 (self : access Inst; p1_P : access QtAda6.QtCore.QPointF.Inst'Class);
   procedure setP1 (self : access Inst; p1_P : access QtAda6.QtCore.QPoint.Inst'Class);
   procedure setP2 (self : access Inst; p2_P : access QtAda6.QtCore.QPointF.Inst'Class);
