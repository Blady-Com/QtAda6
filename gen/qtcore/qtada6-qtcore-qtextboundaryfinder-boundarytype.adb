...
package body QtAda6.QtCore.QTextBoundaryFinder.BoundaryType is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Grapheme"));
   end Grapheme;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Word"));
   end Word;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QTextBoundaryFinder");
      Enum_Class   := Object_GetAttrString (Parent_Class, "BoundaryType");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Sentence"));
   end Sentence;
