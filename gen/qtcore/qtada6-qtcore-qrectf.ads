...
package QtAda6.QtCore.QRectF is
   ...
   function Create (QRectF_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect) return Class;
...
-- function U_add_U(self : access Inst;rhs_P : UNION_QtAda6_QtCore_QMarginsFQtAda6_QtCore_QMargins) return access QtAda6.QtCore.QRectF.Inst'Class;
   function U_and_U
   ...
   function contains (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint) return bool;
   function contains (self : access Inst; r_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect) return bool;
   ...
   function intersected
     (self : access Inst; other_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect)
      return access QtAda6.QtCore.QRectF.Inst'Class;
   function intersects (self : access Inst; r_P : UNION_QtAda6_QtCore_QRectFQtAda6_QtCore_QRect) return bool;
   ...
   procedure moveBottomLeft (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure moveBottomRight (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure moveCenter (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure moveLeft (self : access Inst; pos_P : float);
   procedure moveRight (self : access Inst; pos_P : float);
   procedure moveTo (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure moveTo (self : access Inst; x_P : float; y_P : float);
   procedure moveTop (self : access Inst; pos_P : float);
   procedure moveTopLeft (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure moveTopRight (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   ...
   procedure setBottomLeft (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure setBottomRight (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   ...
   procedure setSize (self : access Inst; s_P : UNION_QtAda6_QtCore_QSizeFQtAda6_QtCore_QSize);
   procedure setTop (self : access Inst; pos_P : float);
   procedure setTopLeft (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
   procedure setTopRight (self : access Inst; p_P : UNION_QtAda6_QtCore_QPointFQtAda6_QtCore_QPoint);
