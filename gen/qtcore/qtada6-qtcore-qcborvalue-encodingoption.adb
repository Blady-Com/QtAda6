...
package body QtAda6.QtCore.QCborValue.EncodingOption is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "NoTransformation"));
   end NoTransformation;
   function SortKeysInMaps return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "SortKeysInMaps"));
   end SortKeysInMaps;
   function UseFloat return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UseFloat"));
   end UseFloat;
   function UseFloat16 return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UseFloat16"));
   end UseFloat16;
   function UseIntegers return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborValue");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "UseIntegers"));
   end UseIntegers;
