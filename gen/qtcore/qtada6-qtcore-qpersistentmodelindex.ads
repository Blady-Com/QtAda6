-------------------------------------------------------------------------------
-- NAME (spec)                  : qtada6-qtcore-qpersistentmodelindex.ads
...
package QtAda6.QtCore.QPersistentModelIndex is
   ...
   type UNION_QtAda6_QtCore_QPersistentModelIndexQtAda6_QtCore_QModelIndex is new Any;
   procedure Finalize (Self : in out Class);
   function Create return Class;
   function Create (index_P : UNION_QtAda6_QtCore_QModelIndexQtAda6_QtCore_QPersistentModelIndex) return Class;
   function Create (other_P : UNION_QtAda6_QtCore_QPersistentModelIndexQtAda6_QtCore_QModelIndex) return Class;
   procedure U_copy_U;
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtCore_QPersistentModelIndexQtAda6_QtCore_QModelIndex);
