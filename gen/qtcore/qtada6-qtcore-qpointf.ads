...
package QtAda6.QtCore.QPointF is
   ...
   function Create (QPointF_P : access QtAda6.QtCore.QPointF.Inst'Class) return Class;
   function Create (QPointF_P : access QtAda6.QtCore.QPoint.Inst'Class) return Class;
-- function Create(p_P : access QtAda6.QtCore.QPoint.Inst'Class) return Class;
   ...
   function U_add_U
     (self : access Inst; p2_P : access QtAda6.QtCore.QPointF.Inst'Class)
      return access QtAda6.QtCore.QPointF.Inst'Class;
   function U_add_U
     (self : access Inst; p2_P : access QtAda6.QtCore.QPoint.Inst'Class) return access QtAda6.QtCore.QPointF.Inst'Class;
   procedure U_copy_U;
   function U_iadd_U
   ...
   function U_sub_U
     (self : access Inst; p2_P : access QtAda6.QtCore.QPoint.Inst'Class) return access QtAda6.QtCore.QPointF.Inst'Class;
   function dotProduct
     (p1_P : access QtAda6.QtCore.QPointF.Inst'Class; p2_P : access QtAda6.QtCore.QPointF.Inst'Class) return float;
   function dotProduct
     (p1_P : access QtAda6.QtCore.QPointF.Inst'Class; p2_P : access QtAda6.QtCore.QPoint.Inst'Class) return float;
   function dotProduct
     (p1_P : access QtAda6.QtCore.QPoint.Inst'Class; p2_P : access QtAda6.QtCore.QPointF.Inst'Class) return float;
   function dotProduct
     (p1_P : access QtAda6.QtCore.QPoint.Inst'Class; p2_P : access QtAda6.QtCore.QPoint.Inst'Class) return float;
