...
package body QtAda6.QtCore.QMetaType is
   ...
   function canConvert
     (fromType_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K;
      toType_P   : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K) return bool
   is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
   ...
   function compare (lhs_P : int; rhs_P : int; typeId_P : int) return TUPLE_boolint is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
   ...
   begin
      ...
      Tuple_SetItem (Args, 1, Long_FromLong (copy_P));
      Result := Object_CallObject (Method, Args, True);
      return Long_AsLong (Result);
   end construct;
   ...
   function convert
     (fromType_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K; from_U_P : int;
      toType_P   : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K; to_P : int) return bool
   is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
   ...
   begin
      ...
      Args   := Tuple_New (1);
      Tuple_SetItem (Args, 0, Long_FromLong (copy_P));
      Result := Object_CallObject (Method, Args, True);
      return Long_AsLong (Result);
   end create;
   ...
   function equals (lhs_P : int; rhs_P : int; typeId_P : int) return TUPLE_boolint is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
   ...
   function fromName (name_P : UNION_QtAda6_QtCore_QByteArraybytes) return access QtAda6.QtCore.QMetaType.Inst'Class is
      Class, Method, Args, List, Result : Handle;
   ...
   procedure unregisterConverterFunction
     (from_U_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K;
      to_P     : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K)
   is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
   ...
   procedure unregisterMetaType (type_K_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K) is
      Class, Method, Args, List, Result : Handle;
   begin
      Class  := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QMetaType");
