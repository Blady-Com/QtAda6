...
package QtAda6.QtCore.QBuffer is
   ...
   procedure setBuffer (self : access Inst; a_P : UNION_QtAda6_QtCore_QByteArraybytes);
   procedure setData (self : access Inst; data_P : UNION_QtAda6_QtCore_QByteArraybytes);
