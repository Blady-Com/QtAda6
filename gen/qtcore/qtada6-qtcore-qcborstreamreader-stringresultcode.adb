...
package body QtAda6.QtCore.QCborStreamReader.StringResultCode is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "StringResultCode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Error"));
   end Error;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QCborStreamReader");
      Enum_Class   := Object_GetAttrString (Parent_Class, "StringResultCode");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "EndOfString"));
   end EndOfString;
