...
package body QtAda6.QtCore.Qt.CursorMoveStyle is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "LogicalMoveStyle"));
   end LogicalMoveStyle;
   function VisualMoveStyle return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "VisualMoveStyle"));
   end VisualMoveStyle;
