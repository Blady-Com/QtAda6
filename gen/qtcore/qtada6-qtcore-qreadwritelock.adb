...
package body QtAda6.QtCore.QReadWriteLock is
   ...
   function Create (recursionMode_P : access QtAda6.QtCore.QReadWriteLock.RecursionMode.Inst'Class) return Class is
      Class, Args : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QReadWriteLock");
      Args  := Tuple_New (1);
      Tuple_SetItem (Args, 0, recursionMode_P.Python_Proxy);
