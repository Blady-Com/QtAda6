...
package QtAda6.QtCore.QJsonDocument is
   ...
   function Create (object_P : DICT_strQtAda6_QtCore_QJsonValue) return Class;
   ...
   function object (self : access Inst) return DICT_strQtAda6_QtCore_QJsonValue;
   procedure setArray (self : access Inst; array_K_P : access QtAda6.QtCore.QJsonArray.Inst'Class);
   procedure setObject (self : access Inst; object_P : DICT_strQtAda6_QtCore_QJsonValue);
