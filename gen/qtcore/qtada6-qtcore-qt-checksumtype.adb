...
package body QtAda6.QtCore.Qt.ChecksumType is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ChecksumIso3309"));
   end ChecksumIso3309;
   function ChecksumItuV41 return Class is
      Parent_Class : Handle;
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "Qt");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "ChecksumItuV41"));
   end ChecksumItuV41;
