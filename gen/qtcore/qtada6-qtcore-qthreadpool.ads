...
package QtAda6.QtCore.QThreadPool is
   ...
   procedure start (self : access Inst; arg_1_P : Callable; priority_P : int);
   procedure start (self : access Inst; runnable_P : access QtAda6.QtCore.QRunnable.Inst'Class; priority_P : int);
   ...
   function waitForDone (self : access Inst; msecs_P : int) return bool;
