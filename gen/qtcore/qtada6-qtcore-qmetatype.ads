...
package QtAda6.QtCore.QMetaType is
   ...
   function canView
     (fromType_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K;
      toType_P   : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K) return bool;
   function compare (lhs_P : int; rhs_P : int; typeId_P : int) return TUPLE_boolint;
   ...
   function equals (lhs_P : int; rhs_P : int; typeId_P : int) return TUPLE_boolint;
   ...
   function fromName (name_P : UNION_QtAda6_QtCore_QByteArraybytes) return access QtAda6.QtCore.QMetaType.Inst'Class;
   ...
   procedure unregisterMetaType (type_K_P : UNION_QtAda6_QtCore_QMetaTypeQtAda6_QtCore_QMetaType_Type_K);
