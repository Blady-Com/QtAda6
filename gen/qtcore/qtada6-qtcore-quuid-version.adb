...
package body QtAda6.QtCore.QUuid.Version is
   ...
   begin
      ...
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "VerUnknown"));
   end VerUnknown;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUuid");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "EmbeddedPOSIX"));
   end EmbeddedPOSIX;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QUuid");
      return new Inst'(Python_Proxy => Object_GetAttrString (Parent_Class, "Random"));
   end Random;
