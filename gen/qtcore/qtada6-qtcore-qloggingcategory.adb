...
package body QtAda6.QtCore.QLoggingCategory is
   ...
   function Create (category_P : bytes; severityLevel_P : access QtAda6.QtCore.QtMsgType.Inst'Class) return Class is
      Class, Args : Handle;
   begin
      ...
      Tuple_SetItem (Args, 1, severityLevel_P.Python_Proxy);
