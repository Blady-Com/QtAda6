...
package body QtAda6.QtCore.QIODeviceBase.OpenModeFlag is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NotOpen"));
   end NotOpen;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "WriteOnly"));
   end WriteOnly;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ReadWrite"));
   end ReadWrite;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Append"));
   end Append;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Truncate"));
   end Truncate;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "Unbuffered"));
   end Unbuffered;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "NewOnly"));
   end NewOnly;
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QIODeviceBase");
      Enum_Class   := Object_GetAttrString (Parent_Class, "OpenModeFlag");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "ExistingOnly"));
   end ExistingOnly;
