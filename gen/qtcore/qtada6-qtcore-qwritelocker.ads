-------------------------------------------------------------------------------
-- NAME (spec)                  : qtada6-qtcore-qwritelocker.ads
...
package QtAda6.QtCore.QWriteLocker is
   type Inst;
   ...
   function U_enter_U (self : access Inst) return access QtAda6.QtCore.QWriteLocker.Inst'Class;
   procedure U_exit_U
