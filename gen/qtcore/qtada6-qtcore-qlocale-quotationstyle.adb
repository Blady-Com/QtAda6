...
package body QtAda6.QtCore.QLocale.QuotationStyle is
   ...
   begin
      ...
      Enum_Class   := Object_GetAttrString (Parent_Class, "QuotationStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "StandardQuotation"));
   ...
   begin
      Parent_Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QLocale");
      Enum_Class   := Object_GetAttrString (Parent_Class, "QuotationStyle");
      return new Inst'(Python_Proxy => Object_GetAttrString (Enum_Class, "AlternateQuotation"));
