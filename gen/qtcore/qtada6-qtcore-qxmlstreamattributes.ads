...
package QtAda6.QtCore.QXmlStreamAttributes is
   type Sequence_QtAda6_QtCore_QXmlStreamAttribute is access Any;
   type List_QtAda6_QtCore_QXmlStreamAttribute is access Any;
   type Inst;
   ...
   function mid (self : access Inst; pos_P : int; len_P : int) return List_QtAda6_QtCore_QXmlStreamAttribute;
