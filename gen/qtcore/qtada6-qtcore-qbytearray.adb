...
package body QtAda6.QtCore.QByteArray is
   ...
   function contains (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   function count (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes) return int is
      Method, Args, List, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "count");
      Args   := Tuple_New (1);
   ...
   function endsWith (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   function indexOf (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes; from_U_P : int := 0) return int is
      Method, Args, List, Result : Handle;
   begin
   ...
   function isSharedWith (self : access Inst; other_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   function lastIndexOf (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes) return int is
      Method, Args, List, Result : Handle;
   begin
   ...
   function lastIndexOf (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes; from_U_P : int) return int is
      Method, Args, List, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "lastIndexOf");
      Args   := Tuple_New (2);
   ...
   procedure push_back (self : access Inst; a_P : UNION_QtAda6_QtCore_QByteArraybytes) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure push_front (self : access Inst; a_P : UNION_QtAda6_QtCore_QByteArraybytes) is
      Method, Args, List, Result : Handle;
   begin
   ...
   function startsWith (self : access Inst; bv_P : UNION_QtAda6_QtCore_QByteArraybytes) return bool is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure swap (self : access Inst; other_P : UNION_QtAda6_QtCore_QByteArraybytes) is
      Method, Args, List, Result : Handle;
   begin
   ...
   begin
      ...
      Args   := Tuple_New (3);
      Tuple_SetItem (Args, 0, (if exclude_P /= null then exclude_P.Python_Proxy else No_Value));
      Tuple_SetItem (Args, 1, (if include_P /= null then include_P.Python_Proxy else No_Value));
