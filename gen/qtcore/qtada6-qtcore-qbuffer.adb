...
package body QtAda6.QtCore.QBuffer is
   ...
   function Create (buf_P : bytes; parent_P : access QtAda6.QtCore.QObject.Inst'Class := null) return Class is
      Class, Args, Dict, List, Tuple, Set : Handle;
   begin
      Class := Object_GetAttrString (QtAda6.QtCore_Python_Proxy, "QBuffer");
      Args  := Tuple_New (1);
   ...
   procedure setBuffer (self : access Inst; a_P : access QtAda6.QtCore.QByteArray.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
   ...
   procedure setBuffer (self : access Inst; a_P : bytes) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
      Method := Object_GetAttrString (self.Python_Proxy, "setBuffer");
      Args   := Tuple_New (1);
   ...
   procedure setData (self : access Inst; data_P : access QtAda6.QtCore.QByteArray.Inst'Class) is
      Method, Args, Dict, List, Tuple, Set, Result : Handle;
   begin
