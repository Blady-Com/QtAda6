...
package body QtAda6.QtCore.QBuffer is
   ...
   function Create
     (buf_P : UNION_QtAda6_QtCore_QByteArraybytes; parent_P : access QtAda6.QtCore.QObject.Inst'Class := null)
      return Class
   is
   ...
   procedure setBuffer (self : access Inst; a_P : UNION_QtAda6_QtCore_QByteArraybytes) is
      Method, Args, List, Result : Handle;
   begin
   ...
   procedure setData (self : access Inst; data_P : UNION_QtAda6_QtCore_QByteArraybytes) is
      Method, Args, List, Result : Handle;
   begin
