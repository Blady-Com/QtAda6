...
package body QtAda6.QtCore.QAbstractItemModel is
   ...
   function columnsAboutToBeInserted (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   function headerDataChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "headerDataChanged"));
   end headerDataChanged;
   function layoutAboutToBeChanged (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
   ...
   function modelAboutToBeReset (self : access Inst) return CLASSVAR_Signal is
   begin
      return
   ...
   function modelReset (self : access Inst) return CLASSVAR_Signal is
   begin
      return new QtAda6.QtCore.Signal.Inst'(Python_Proxy => Object_GetAttrString (self.Python_Proxy, "modelReset"));
   end modelReset;
   function rowsAboutToBeInserted (self : access Inst) return CLASSVAR_Signal is
   begin
      return
        new QtAda6.QtCore.Signal.Inst'
          (Python_Proxy => Object_GetAttrString (self.Python_Proxy, "rowsAboutToBeInserted"));
   end rowsAboutToBeInserted;
   function rowsAboutToBeMoved (self : access Inst) return CLASSVAR_Signal is
   begin
      return
