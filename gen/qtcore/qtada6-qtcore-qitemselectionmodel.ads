...
package QtAda6.QtCore.QItemSelectionModel is
   ...
   function currentChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- currentChanged(QModelIndex,QModelIndex)
   function currentColumnChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- currentColumnChanged(QModelIndex,QModelIndex)
   function currentRowChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- currentRowChanged(QModelIndex,QModelIndex)
   function modelChanged
     (self : access Inst) return access QtAda6.QtCore.Signal.Inst'Class;-- modelChanged(QAbstractItemModel*)
   function selectionChanged
     (self : access Inst)
      return access QtAda6.QtCore.Signal.Inst'Class;-- selectionChanged(QItemSelection,QItemSelection)
   function Create
   ...
   function isRowSelected
     (self : access Inst; row_P : int; parent_P : access QtAda6.QtCore.QPersistentModelIndex.Inst'Class := null)
      return bool;
   function isSelected (self : access Inst; index_P : access QtAda6.QtCore.QModelIndex.Inst'Class) return bool;
   function isSelected
   ...
   function selection (self : access Inst) return access QtAda6.QtCore.QItemSelection.Inst'Class;
