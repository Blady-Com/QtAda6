...
-- function globalMatch(self : access Inst;subjectView_P : str;offset_P : int;matchType_P : access QtAda6.QtCore.QRegularExpression.MatchType.Inst'Class;matchOptions_P : access QtAda6.QtCore.QRegularExpression.MatchOption.Inst'Class) return access QtAda6.QtCore.QRegularExpressionMatchIterator.Inst'Class;
...
-- function match_F(self : access Inst;subjectView_P : str;offset_P : int;matchType_P : access QtAda6.QtCore.QRegularExpression.MatchType.Inst'Class;matchOptions_P : access QtAda6.QtCore.QRegularExpression.MatchOption.Inst'Class) return access QtAda6.QtCore.QRegularExpressionMatch.Inst'Class;
   function matchView
     (self           : access Inst; subjectView_P : str; offset_P : int;
      matchType_P    : access QtAda6.QtCore.QRegularExpression.MatchType.Inst'Class;
      matchOptions_P : access QtAda6.QtCore.QRegularExpression.MatchOption.Inst'Class)
